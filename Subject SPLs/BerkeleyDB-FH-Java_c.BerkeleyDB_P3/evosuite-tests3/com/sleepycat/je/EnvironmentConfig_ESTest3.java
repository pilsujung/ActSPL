...
public class EnvironmentConfig_ESTest3 extends EnvironmentConfig_ESTest_scaffolding3 {
  ...
  public void test09()  throws Throwable  {
      ...
      try { 
        environmentConfig0.setTxnTimeout((-1931L));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // com.sleepycat.je.config.LongConfigParam: param je.txn.timeout doesn't validate, -1931 is less than min of 0
         //
  ...
  public void test10()  throws Throwable  {
      ...
      try { 
        environmentConfig0.setConfigParam("je.env.recoveryForceCheckpoint", (String) null);
  ...
  public void test18()  throws Throwable  {
      EnvironmentConfig environmentConfig0 = EnvironmentConfig.DEFAULT;
      try { 
        environmentConfig0.setLockTimeout((-690L));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // com.sleepycat.je.config.LongConfigParam: param je.lock.timeout doesn't validate, -690 is less than min of 0
         //
         assertThrownBy("com.sleepycat.je.config.LongConfigParam", e);
      }
  }
  ...
  public void test21()  throws Throwable  {
      long long0 = EnvironmentConfig.DEFAULT.getTxnTimeout();
