...
public class DbConfigManager_ESTest5 extends DbConfigManager_ESTest_scaffolding5 {
  ...
  public void test09()  throws Throwable  {
      ...
      DbConfigManager dbConfigManager0 = new DbConfigManager(environmentConfig0);
      try { 
        dbConfigManager0.get("n");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // n is not a valid BDBJE environment configuration
         //
  ...
  public void test12()  throws Throwable  {
      EnvironmentConfig environmentConfig0 = new EnvironmentConfig();
      DbConfigManager dbConfigManager0 = new DbConfigManager(environmentConfig0);
      String string0 = dbConfigManager0.get("je.compressor.lockTimeout");
      assertEquals("500000", string0);
  }
