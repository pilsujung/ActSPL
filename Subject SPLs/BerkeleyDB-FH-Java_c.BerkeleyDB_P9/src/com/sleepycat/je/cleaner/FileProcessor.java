...
@MethodObject static  class  FileProcessor_processFile {
    ...
    protected void hook120() throws DatabaseException, IOException {
     ...
     private void  hook127__wrappee__base  () throws DatabaseException, IOException {
    }

		
    protected void hook127() throws DatabaseException, IOException {
     // lookAheadCache=new LookAheadCache(lookAheadCacheSize);
      hook127__wrappee__base();
    }

		
     private void  hook128__wrappee__base  () throws DatabaseException, IOException {
    }

		
    protected void hook128() throws DatabaseException, IOException {
      lookAheadCacheSize=_this.cleaner.lookAheadCacheSize;
      hook128__wrappee__base();
    }

		
     private void  hook129__wrappee__base  () throws DatabaseException, IOException {
    }
    ...
    //  }
      hook129__wrappee__base();
    }

		
     private void  hook130__wrappee__base  () throws DatabaseException, IOException {
      p=null;
      this.hook131();
    ...
    //  if (lookAheadCache.isFull()) {
        hook130__wrappee__base();
    //  }
    }

		
     private void  hook131__wrappee__base  () throws DatabaseException, IOException {
    }

		
    protected void hook131() throws DatabaseException, IOException {
   //   p=lookAheadCache;
      hook131__wrappee__base();
    }
      ...
      budget=_this.env.getMemoryBudget();
{
    ...
    protected void hook162() throws DatabaseException, IOException {
     ...
     private void  hook118__wrappee__MemoryBudget  () throws DatabaseException, IOException {
    }
    ...
    protected void hook118() throws DatabaseException, IOException {
     ...
     private void  hook116__wrappee__LookAHEADCache  () throws DatabaseException, IOException {
    }
        ...
        isDupCountLN=ln.containsDuplicates();
{
    ...
    protected void hook126() throws DatabaseException {
     ...
     private void  hook132__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook132() throws DatabaseException {
      ...
      hook132__wrappee__base();
    }

		
     private void  hook133__wrappee__base  () throws DatabaseException {
    }
   ...
   private void  hook121__wrappee__base  (  String traceMsg) throws DatabaseException, IOException {
  }

	
  protected void hook121(  String traceMsg) throws DatabaseException, IOException {
    Tracer.trace(Level.INFO,env,traceMsg);
    hook121__wrappee__base(traceMsg);
  }
