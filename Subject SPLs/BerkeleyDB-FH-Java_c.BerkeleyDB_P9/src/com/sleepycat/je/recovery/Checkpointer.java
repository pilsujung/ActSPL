...
@MethodObject static  class  Checkpointer_isRunnable {
    ...
    protected StringBuffer sb;
     ...
     private void  hook521__wrappee__base  () throws DatabaseException {
    }
      ...
      }
{
    ...
    protected void hook517() throws DatabaseException {
     ...
     private void  hook518__wrappee__LoggingFinest  () throws DatabaseException {
    }

		
    protected void hook518() throws DatabaseException {
      sb.append(" time interval=").append(useTimeInterval);
      hook518__wrappee__LoggingFinest();
    }
