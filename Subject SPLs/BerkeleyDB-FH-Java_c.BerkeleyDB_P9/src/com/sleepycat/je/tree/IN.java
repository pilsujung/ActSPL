 ...
 */
   private void  init__wrappee__base  (  DatabaseImpl db,  byte[] identifierKey,  int initialCapacity,  int level){
    setDatabase(db);
 ...
 */
  protected void init(  DatabaseImpl db,  byte[] identifierKey,  int initialCapacity,  int level){
    init__wrappee__base(db,identifierKey,initialCapacity,level);
 ...
 */
   private void  postRecoveryInit__wrappee__base  (  DatabaseImpl db,  long sourceLsn){
    setDatabase(db);
    setLastFullLsn(sourceLsn);
  }
 ...
 */
  public void postRecoveryInit(  DatabaseImpl db,  long sourceLsn){
    postRecoveryInit__wrappee__base(db,sourceLsn);
    initMemorySize();
  }
 ...
 */
   private void  latch__wrappee__base  (  boolean updateGeneration) throws DatabaseException {
    if (updateGeneration) {
      setGeneration();
    }
  }
 ...
 */
  public void latch(  boolean updateGeneration) throws DatabaseException {
    latch__wrappee__base(updateGeneration);
    latch.acquire();
  }
 ...
 */
   private void  updateEntry__wrappee__base  (  int idx,  long lsn,  long oldLNSize,  long newLNSize){
    setLsn(idx,lsn);
    setDirty(true);
  }
 ...
 */
  public void updateEntry(  int idx,  long lsn,  long oldLNSize,  long newLNSize){
    ...
    updateEntry__wrappee__base(idx,lsn,oldLNSize,newLNSize);
  }
 ...
 */
   private void  rebuildINList__wrappee__base  (  INList inList) throws DatabaseException {
    inList.add(this);
 ...
 */
  void rebuildINList(  INList inList) throws DatabaseException {
    initMemorySize();
    rebuildINList__wrappee__base(inList);
  }
 ...
 */
  void findParent(  Tree.SearchType searchType,  long targetNodeId,  boolean targetContainsDuplicates,  boolean targetIsRoot,  byte[] targetMainTreeKey,  byte[] targetDupTreeKey,  SearchResult result,  boolean requireExactMatch,  boolean updateGeneration,  int targetLevel,  List trackingList,  boolean doFetch) throws DatabaseException {
    assert isLatchOwner();
    findParent__wrappee__base(searchType,targetNodeId,targetContainsDuplicates,targetIsRoot,targetMainTreeKey,targetDupTreeKey,result,requireExactMatch,updateGeneration,targetLevel,trackingList,doFetch);
  }
 ...
 */
   private void  readFromLog__wrappee__base  (  ByteBuffer itemBuffer,  byte entryTypeVersion) throws LogException {
 ...
 */
  public void readFromLog(  ByteBuffer itemBuffer,  byte entryTypeVersion) throws LogException {
    readFromLog__wrappee__base(itemBuffer,entryTypeVersion);
...
@MethodObject static  class  IN_setEntry {
    ...
    protected long newSize;
     ...
     private void  hook640__wrappee__base  (){
    }
    ...
    protected void hook640(){
      ...
      hook640__wrappee__base();
    }

		
     private void  hook641__wrappee__base  (){
    }

		
    protected void hook641(){
      oldSize=0;
      hook641__wrappee__base();
    }
...
@MethodObject static  class  IN_updateEntry2 {
    ...
    protected long newSize;
     ...
     private void  hook642__wrappee__base  (){
    }
...
@MethodObject static  class  IN_updateEntry3 {
    ...
    protected long newSize;
     ...
     private void  hook643__wrappee__base  (){
    }
...
@MethodObject static  class  IN_updateEntryCompareKey {
    ...
    protected long newSize;
     ...
     private void  hook644__wrappee__base  (){
    }
...
@MethodObject static  class  IN_insertEntry1 {
    ...
    protected int oldSize;
     ...
     private void  hook645__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook645() throws DatabaseException {
      _this.updateMemorySize(0,_this.getEntryInMemorySize(index));
      hook645__wrappee__base();
    }

		
     private void  hook646__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook646() throws DatabaseException {
     ...
     private void  hook647__wrappee__base  () throws DatabaseException {
    }
...
@MethodObject static  class  IN_deleteEntry {
    ...
    protected int oldLSNArraySize;
     ...
     private void  hook616__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook616() throws DatabaseException {
      _this.traceDelete(Level.FINEST,index);
      hook616__wrappee__base();
    }

		
     private void  hook648__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook648() throws DatabaseException {
      _this.updateMemorySize(oldLSNArraySize,_this.computeLsnOverhead());
      hook648__wrappee__base();
    }

		
     private void  hook649__wrappee__base  () throws DatabaseException {
    }
...
@MethodObject static  class  IN_validateSubtreeBeforeDelete {
    ...
    protected Node child;
     ...
     private void  hook628__wrappee__base  () throws DatabaseException {
      this.hook629();
      if (index >= _this.nEntries) {
    ...
    protected void hook628() throws DatabaseException {
     ...
     private void  hook629__wrappee__base  () throws DatabaseException {
    }
      ...
      }
{
    ...
    protected long newSize;
     ...
     private void  hook617__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook617() throws DatabaseException {
      ...
      hook617__wrappee__base();
    }

		
     private void  hook630__wrappee__base  () throws DatabaseException {
      toIdx=0;
    ...
    protected void hook630() throws DatabaseException {
     ...
     private void  hook631__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook631() throws DatabaseException {
      newSibling.latch();
      hook631__wrappee__base();
    }

		
     private void  hook636__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook636() throws DatabaseException {
      ...
      hook636__wrappee__base();
    }

		
     private void  hook650__wrappee__base  () throws DatabaseException {
    }
...
@MethodObject static  class  IN_verify {
    ...
    protected boolean inconsistent;
     ...
     private void  hook632__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook632() throws DatabaseException {
      ...
      hook632__wrappee__base();
    }

		
     private void  hook633__wrappee__base  () throws DatabaseException {
    }
...
@MethodObject static  class  IN_isValidForDelete {
    ...
    protected Node child;
     ...
     private void  hook634__wrappee__base  () throws DatabaseException {
      this.hook635();
      if (_this.nEntries > 1) {
    ...
    protected void hook634() throws DatabaseException {
     ...
     private void  hook635__wrappee__base  () throws DatabaseException {
    }
...
@MethodObject static  class  IN_trackProvisionalObsolete {
    ...
    protected int childMemDelta;
     ...
     private void  hook651__wrappee__base  (){
    }
...
@MethodObject static  class  IN_flushProvisionalObsolete {
    ...
    protected int memDelta;
     ...
     private void  hook655__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook655() throws DatabaseException {
      _this.changeMemorySize(0 - memDelta);
      hook655__wrappee__base();
    }

		
     private void  hook656__wrappee__base  () throws DatabaseException {
    }
   ...
   private void  hook618__wrappee__base  (  EnvironmentImpl env){
  }

	
  protected void hook618(  EnvironmentImpl env){
    latch=LatchSupport.makeLatch(shortClassName() + getNodeId(),env);
    hook618__wrappee__base(env);
  }

	
   private void  hook619__wrappee__base  (  boolean updateGeneration) throws DatabaseException {
    if (updateGeneration) {
      setGeneration();
    }
    throw new ReturnBoolean(true);
  ...
  protected void hook619(  boolean updateGeneration) throws DatabaseException {
    if (latch.acquireNoWait()) {
      hook619__wrappee__base(updateGeneration);
    }
 else {
      throw new ReturnBoolean(false);
    }
   ...
   private void  hook620__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook620() throws DatabaseException {
    releaseLatch();
    hook620__wrappee__base();
  }

	
   private void  hook621__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook621() throws DatabaseException {
    releaseLatch();
    hook621__wrappee__base();
  }

	
   private void  hook622__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook622() throws DatabaseException {
    releaseLatch();
    hook622__wrappee__base();
  }

	
   private void  hook623__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook623() throws DatabaseException {
    releaseLatch();
    hook623__wrappee__base();
  }

	
   private void  hook624__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook624() throws DatabaseException {
    releaseLatch();
    hook624__wrappee__base();
  }

	
   private void  hook625__wrappee__base  (  Node child) throws DatabaseException {
  }

	
  protected void hook625(  Node child) throws DatabaseException {
    ((IN)child).releaseLatch();
    hook625__wrappee__base(child);
  }

	
   private void  hook626__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook626() throws DatabaseException {
    releaseLatch();
    hook626__wrappee__base();
  }

	
   private void  hook627__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook627() throws DatabaseException {
    releaseLatch();
    hook627__wrappee__base();
  }

	
   private void  hook637__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook637() throws DatabaseException {
    initMemorySize();
    hook637__wrappee__base();
  }

	
   private void  hook638__wrappee__base  (  Node node) throws DatabaseException, LogFileNotFoundException, Exception {
  }

	
  protected void hook638(  Node node) throws DatabaseException, LogFileNotFoundException, Exception {
    updateMemorySize(null,node);
    hook638__wrappee__base(node);
  }
...
@MethodObject static  class  IN_traceSplit {
    ...
    IN_traceSplit(    IN _this,    Level level,    IN parent,    IN newSibling,    long parentLsn,    long myNewLsn,    long newSiblingLsn,    int splitIndex,    int idKeyIndex,    int childIndex){
     ...
     private void  execute__wrappee__LoggingFine  (){
    }
...
@MethodObject static  class  IN_traceDelete {
    ...
    IN_traceDelete(    IN _this,    Level level,    int index){
     ...
     private void  execute__wrappee__LoggingFinest  (){
    }
