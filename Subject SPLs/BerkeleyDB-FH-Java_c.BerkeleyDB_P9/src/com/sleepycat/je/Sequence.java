 ...
 */
  private DatabaseEntry copyEntry(  DatabaseEntry entry){
   ...
   private void  hook82__wrappee__base  (  boolean cached,  boolean wrapped,  long retVal) throws DatabaseException {
  }
  ...
  protected void hook82(  boolean cached,  boolean wrapped,  long retVal) throws DatabaseException {
    ...
    hook82__wrappee__base(cached,wrapped,retVal);
  }
