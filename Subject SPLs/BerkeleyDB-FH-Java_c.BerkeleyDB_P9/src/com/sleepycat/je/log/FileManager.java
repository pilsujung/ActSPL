 ...
 */
   private void  clear__wrappee__base  () throws IOException, DatabaseException {
    endOfLog.close();
  }
 ...
 * Close all file handles and empty the cache.
 */
   private void  clear__wrappee__FileHandleCache  () throws IOException, DatabaseException {
{
      this.hook451();
    }
 ...
 */
  public void clear() throws IOException, DatabaseException {
    ...
    clear__wrappee__FileHandleCache();
  }
 ...
 * Clear the file lock.
 */
   private void  close__wrappee__base  () throws IOException, DatabaseException {
  }
...
@MethodObject static  class  FileManager_writeToFile {
    ...
    FileManager_writeToFile(    FileManager _this,    RandomAccessFile file,    ByteBuffer data,    long destOffset){
     ...
     private int  execute__wrappee__base  () throws IOException, DatabaseException {
      totalBytesWritten=0;
      this.hook455();
      this.hook445();
    ...
    int execute() throws IOException, DatabaseException {
      int result=execute__wrappee__base();
{
        this.hook447();
      }
      return result;
    ...
    protected void hook455() throws IOException, DatabaseException {
     ...
     private void  hook447__wrappee__IO  () throws IOException, DatabaseException {
...
@MethodObject static  class  FileManager_readFromFile {
    ...
    FileManager_readFromFile(    FileManager _this,    RandomAccessFile file,    ByteBuffer readBuffer,    long offset){
     ...
     private void  execute__wrappee__base  () throws IOException {
      this.hook446();
    }
      ...
      execute__wrappee__base();
{
    ...
    protected void hook446() throws IOException {
     ...
     private void  hook448__wrappee__IO  () throws IOException {
...
synchronized (file) {
   ...
   private void  hook449__wrappee__base  (  EnvironmentImpl envImpl) throws DatabaseException {
  }
  ...
  protected void hook449(  EnvironmentImpl envImpl) throws DatabaseException {
    ...
    hook449__wrappee__base(envImpl);
  }

	
   private FileHandle  hook450__wrappee__base  (  long fileNum,  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
  ...
  protected FileHandle hook450(  long fileNum,  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
    fileCacheLatch.acquire();
    try {
      fileHandle=hook450__wrappee__base(fileNum,fileId,fileHandle);
    }
  finally {
   ...
   private void  hook452__wrappee__base  (  EnvironmentImpl envImpl) throws DatabaseException {
  }

	
  protected void hook452(  EnvironmentImpl envImpl) throws DatabaseException {
    syncManager=new FSyncManager(envImpl);
    hook452__wrappee__base(envImpl);
  }

	
   private void  hook453__wrappee__base  (  FileHandle fileHandle) throws LogException, DatabaseException {
  }

	
  protected void hook453(  FileHandle fileHandle) throws LogException, DatabaseException {
    fileHandle.latch();
    hook453__wrappee__base(fileHandle);
  }

	
   private void  hook454__wrappee__base  (  FileHandle fileHandle) throws LogException, DatabaseException {
  }

	
  protected void hook454(  FileHandle fileHandle) throws LogException, DatabaseException {
    fileHandle.release();
    hook454__wrappee__base(fileHandle);
  }
  ...
  protected void hook456(  DbConfigManager configManager) throws DatabaseException {
   ...
   private void  hook457__wrappee__base  (  DbConfigManager configManager) throws DatabaseException {
  }

	
  protected void hook457(  DbConfigManager configManager) throws DatabaseException {
    fileCache=new FileCache(configManager);
    hook457__wrappee__base(configManager);
  }

	
   private void  hook458__wrappee__base  (  long fileNum) throws DatabaseException, IOException {
  }

	
  protected void hook458(  long fileNum) throws DatabaseException, IOException {
    clearFileCache(fileNum);
    hook458__wrappee__base(fileNum);
  }

	
   private void  hook459__wrappee__base  (  long fileNum) throws DatabaseException, IOException {
  }

	
  protected void hook459(  long fileNum) throws DatabaseException, IOException {
    clearFileCache(fileNum);
    hook459__wrappee__base(fileNum);
  }

	
   private void  hook460__wrappee__base  (  long fileNum,  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
  ...
  protected void hook460(  long fileNum,  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
    while (true) {
      hook460__wrappee__base(fileNum,fileId,fileHandle);
    }
  }

	
   private void  hook461__wrappee__base  (  ByteBuffer data){
  }

	
  protected void hook461(  ByteBuffer data){
    data.position(0);
    hook461__wrappee__base(data);
  }

	
   private FileHandle  hook462__wrappee__base  (  long fileNum,  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
  ...
  protected FileHandle hook462(  long fileNum,  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
    ...
    if (fileHandle == null) {
      fileHandle=hook462__wrappee__base(fileNum,fileId,fileHandle);
    }
    return fileHandle;
  }

	
   private FileHandle  hook463__wrappee__base  (  long fileNum,  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
  ...
  protected FileHandle hook463(  long fileNum,  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
    fileHandle=fileCache.get(fileId);
    if (fileHandle == null) {
      fileHandle=hook463__wrappee__base(fileNum,fileId,fileHandle);
    }
    return fileHandle;
  }

	
   private void  hook464__wrappee__base  (  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
  }
  ...
  protected void hook464(  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
    ...
    hook464__wrappee__base(fileId,fileHandle);
  }
  ...
  protected void hook466(  LogBuffer fullBuffer,  long firstLsn,  RandomAccessFile file,  ByteBuffer data,  IOException IOE) throws DatabaseException {
   ...
   private void  hook467__wrappee__base  (  boolean readOnly) throws DatabaseException {
  }

	
  protected void hook467(  boolean readOnly) throws DatabaseException {
    lockEnvironment(readOnly,false);
    hook467__wrappee__base(readOnly);
  }
 ...
 */
   private void  clearFileCache__wrappee__FileHandleCache  (  long fileNum) throws IOException, DatabaseException {
 ...
 */
  private void clearFileCache(  long fileNum) throws IOException, DatabaseException {
    fileCacheLatch.acquire();
    try {
      clearFileCache__wrappee__FileHandleCache(fileNum);
    }
  finally {
      fileCacheLatch.release();
    }
   ...
   private void  hook451__wrappee__FileHandleCache  () throws IOException, DatabaseException {
    fileCache.clear();
  }
  ...
  protected void hook451() throws IOException, DatabaseException {
    try {
      hook451__wrappee__FileHandleCache();
    }
  finally {
      fileCacheLatch.release();
    }
