...
@MethodObject static  class  LogManager_getLogEntryFromLogSource {
  ...
  protected boolean hook500(  LoggableObject item,  int entrySize,  boolean wakeupCheckpointer) throws IOException, DatabaseException {
   ...
   private void  hook501__wrappee__base  (  boolean fsyncRequired) throws DatabaseException {
  }
  ...
  protected void hook501(  boolean fsyncRequired) throws DatabaseException {
    ...
    hook501__wrappee__base(fsyncRequired);
  }

	
   private void  hook502__wrappee__base  (  EnvironmentImpl envImpl) throws DatabaseException {
  }
  ...
  protected void hook502(  EnvironmentImpl envImpl) throws DatabaseException {
    ...
    hook502__wrappee__base(envImpl);
  }

	
   private boolean  hook503__wrappee__base  (  ByteBuffer marshalledBuffer,  int entrySize,  long currentLsn,  boolean usedTemporaryBuffer,  LogBuffer useLogBuffer) throws IOException, DatabaseException, Exception {
  ...
  protected boolean hook503(  ByteBuffer marshalledBuffer,  int entrySize,  long currentLsn,  boolean usedTemporaryBuffer,  LogBuffer useLogBuffer) throws IOException, DatabaseException, Exception {
    ...
    try {
      usedTemporaryBuffer=hook503__wrappee__base(marshalledBuffer,entrySize,currentLsn,usedTemporaryBuffer,useLogBuffer);
    }
  finally {
