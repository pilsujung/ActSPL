 ...
 */
   private void  init__wrappee__base  (  Locker locker) throws DatabaseException {
 ...
 */
  ...
  static UnsupportedOperationException notAllowedException(){
   ...
   private void  hook79__wrappee__base  (  Transaction txn,  DatabaseEntry key) throws DatabaseException {
  }
  ...
  protected void hook79(  Transaction txn,  DatabaseEntry key) throws DatabaseException {
    ...
    hook79__wrappee__base(txn,key);
  }

	
   private void  hook80__wrappee__base  (  Transaction txn,  DatabaseEntry key,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook80(  Transaction txn,  DatabaseEntry key,  LockMode lockMode) throws DatabaseException {
    ...
    hook80__wrappee__base(txn,key,lockMode);
  }

	
   private void  hook81__wrappee__base  (  Transaction txn,  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
  }
  ...
  protected void hook81(  Transaction txn,  DatabaseEntry key,  DatabaseEntry data,  LockMode lockMode) throws DatabaseException {
    ...
    hook81__wrappee__base(txn,key,data,lockMode);
  }
