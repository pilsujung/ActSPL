...
public class DatabaseEntry_ESTest7 extends DatabaseEntry_ESTest_scaffolding7 {

  @Test
  public void test00()  throws Throwable  {
      DatabaseEntry databaseEntry0 = new DatabaseEntry();
      databaseEntry0.setSize(1838);
  ...
  public void test01()  throws Throwable  {
      ...
      databaseEntry0.setData(byteArray0, (int) (byte)0, (-1));
      int int0 = databaseEntry0.getSize();
      assertEquals((-1), int0);
  }
  ...
  public void test02()  throws Throwable  {
      DatabaseEntry databaseEntry0 = new DatabaseEntry();
      databaseEntry0.setPartial(1121, 1121, true);
  ...
  public void test03()  throws Throwable  {
      DatabaseEntry databaseEntry0 = new DatabaseEntry();
      databaseEntry0.setPartialOffset((-1755));
      int int0 = databaseEntry0.getPartialOffset();
  ...
  public void test04()  throws Throwable  {
      DatabaseEntry databaseEntry0 = new DatabaseEntry();
      databaseEntry0.setPartialLength(1207);
  ...
  public void test05()  throws Throwable  {
      ...
      databaseEntry0.setPartialLength((-605));
      int int0 = databaseEntry0.getPartialLength();
  ...
  public void test06()  throws Throwable  {
      ...
      assertEquals(1121, databaseEntry0.getPartialLength());
      assertTrue(boolean0);
  }
  ...
  public void test07()  throws Throwable  {
      ...
      DatabaseEntry databaseEntry0 = new DatabaseEntry(byteArray0, (int) (byte)41, (int) (byte)0);
  ...
  public void test08()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      DatabaseEntry databaseEntry0 = new DatabaseEntry(byteArray0, 807, 807);
      databaseEntry0.setData(byteArray0, (-1), (-610));
      int int0 = databaseEntry0.getOffset();
      assertEquals(-610, databaseEntry0.getSize());
      assertEquals((-1), int0);
  }
  ...
  public void test13()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      DatabaseEntry databaseEntry0 = new DatabaseEntry(byteArray0, 822, (-1183));
      boolean boolean0 = databaseEntry0.equals(databaseEntry0);
      assertEquals(0, databaseEntry0.getPartialOffset());
      assertEquals(-1183, databaseEntry0.getSize());
      assertFalse(databaseEntry0.getPartial());
      assertTrue(boolean0);
      assertEquals(822, databaseEntry0.getOffset());
      assertEquals(0, databaseEntry0.getPartialLength());
  }
  ...
  public void test16()  throws Throwable  {
      byte[] byteArray0 = new byte[1];
      DatabaseEntry databaseEntry0 = new DatabaseEntry(byteArray0, 1606, 943);
      // Undeclared exception!
      try { 
  ...
  public void test19()  throws Throwable  {
      ...
      DatabaseEntry databaseEntry1 = new DatabaseEntry(byteArray0, (int) (byte)0, (-1));
      boolean boolean0 = databaseEntry0.equals(databaseEntry1);
      assertEquals(0, databaseEntry1.getPartialOffset());
      assertFalse(databaseEntry1.getPartial());
      assertEquals(0, databaseEntry0.getPartialLength());
  ...
  public void test23()  throws Throwable  {
      DatabaseEntry databaseEntry0 = new DatabaseEntry();
      boolean boolean0 = databaseEntry0.equals("~~t*eTgGw6_@DSDx?");
      assertEquals(0, databaseEntry0.getOffset());
      assertFalse(boolean0);
      assertEquals(0, databaseEntry0.getPartialLength());
      assertFalse(databaseEntry0.getPartial());
  ...
  public void test28()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      DatabaseEntry databaseEntry0 = new DatabaseEntry(byteArray0, 0, 1738);
      databaseEntry0.getData();
      assertFalse(databaseEntry0.getPartial());
      assertEquals(0, databaseEntry0.getPartialLength());
      assertEquals(0, databaseEntry0.getPartialOffset());
      assertEquals(0, databaseEntry0.getOffset());
      assertEquals(1738, databaseEntry0.getSize());
  }
  ...
  public void test36()  throws Throwable  {
      byte[] byteArray0 = new byte[0];
      DatabaseEntry databaseEntry0 = new DatabaseEntry(byteArray0, 291, 291);
      DatabaseEntry databaseEntry1 = new DatabaseEntry(byteArray0, 291, (-97));
      boolean boolean0 = databaseEntry0.equals(databaseEntry1);
      assertEquals(291, databaseEntry1.getOffset());
      assertFalse(databaseEntry1.getPartial());
      assertEquals(0, databaseEntry1.getPartialOffset());
      assertEquals(-97, databaseEntry1.getSize());
      assertEquals(0, databaseEntry1.getPartialLength());
      assertFalse(databaseEntry1.equals((Object)databaseEntry0));
      assertFalse(boolean0);
  }
