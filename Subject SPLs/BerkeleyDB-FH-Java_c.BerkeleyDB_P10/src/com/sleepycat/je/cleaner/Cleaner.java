 ...
 */
   private void  updateReadOnlyFileCollections__wrappee__base  (){
 ...
 */
  public void updateReadOnlyFileCollections(){
    updateReadOnlyFileCollections__wrappee__base();
...
@MethodObject static  class  Cleaner_processPending {
    ...
    protected DatabaseImpl db2;
     ...
     private void  hook114__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook114() throws DatabaseException {
      ...
      hook114__wrappee__base();
    }

		
     private void  hook86__wrappee__CriticalEviction  () throws DatabaseException {
    }

		
    protected void hook86() throws DatabaseException {
      _this.env.getEvictor().doCriticalEviction();
      hook86__wrappee__CriticalEviction();
    }
  ...
  protected void hook89(  DatabaseException DBE) throws DatabaseException {
   ...
   private void  hook90__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook90() throws DatabaseException {
    ...
    hook90__wrappee__base();
  }

	
   private void  hook91__wrappee__base  (  LN ln,  boolean obsolete,  boolean completed) throws DatabaseException {
  }
  ...
  protected void hook91(  LN ln,  boolean obsolete,  boolean completed) throws DatabaseException {
    ...
    hook91__wrappee__base(ln,obsolete,completed);
  }

	
   private void  hook92__wrappee__base  (  long lsn,  String cleanAction,  boolean obsolete,  boolean migrated,  boolean completed,  LN ln) throws DatabaseException {
  }
  ...
  protected void hook92(  long lsn,  String cleanAction,  boolean obsolete,  boolean migrated,  boolean completed,  LN ln) throws DatabaseException {
    ...
    hook92__wrappee__base(lsn,cleanAction,obsolete,migrated,completed,ln);
  }

	
   private void  hook93__wrappee__base  (  long lsn,  String cleanAction,  boolean obsolete,  boolean migrated,  boolean completed,  LN ln) throws DatabaseException {
  }
  ...
  protected void hook93(  long lsn,  String cleanAction,  boolean obsolete,  boolean migrated,  boolean completed,  LN ln) throws DatabaseException {
    trace(detailedTraceLevel,cleanAction,ln,lsn,completed,obsolete,migrated);
    hook93__wrappee__base(lsn,cleanAction,obsolete,migrated,completed,ln);
  }
  ...
  protected void hook94(  DbConfigManager cm) throws DatabaseException {
   ...
   private void  hook95__wrappee__base  (  BIN bin,  DIN parentDIN) throws DatabaseException {
  }
  ...
  protected void hook95(  BIN bin,  DIN parentDIN) throws DatabaseException {
    ...
    hook95__wrappee__base(bin,parentDIN);
  }

	
   private void  hook96__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook96() throws DatabaseException {
    nCleanerDeletions++;
    hook96__wrappee__base();
  }

	
   private void  hook97__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook97() throws DatabaseException {
    nPendingLNsProcessed++;
    hook97__wrappee__base();
  }

	
   private void  hook98__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook98() throws DatabaseException {
    nLNsDead++;
    hook98__wrappee__base();
  }

	
   private void  hook99__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook99() throws DatabaseException {
    nPendingLNsLocked++;
    hook99__wrappee__base();
  }

	
   private void  hook100__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook100() throws DatabaseException {
    nLNsDead++;
    hook100__wrappee__base();
  }

	
   private void  hook101__wrappee__base  (){
  }

	
  protected void hook101(){
    nMarkedLNsProcessed++;
    hook101__wrappee__base();
  }

	
   private void  hook102__wrappee__base  (){
  }

	
  protected void hook102(){
    nToBeCleanedLNsProcessed++;
    hook102__wrappee__base();
  }

	
   private void  hook103__wrappee__base  (){
  }

	
  protected void hook103(){
    nClusterLNsProcessed++;
    hook103__wrappee__base();
  }

	
   private void  hook104__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook104() throws DatabaseException {
    nLNsMigrated++;
    hook104__wrappee__base();
  }

	
   private void  hook105__wrappee__base  (  boolean wasCleaned) throws DatabaseException {
  }
  ...
  protected void hook105(  boolean wasCleaned) throws DatabaseException {
    ...
    hook105__wrappee__base(wasCleaned);
  }

	
   private void  hook106__wrappee__base  (  boolean wasCleaned) throws DatabaseException {
  }
  ...
  protected void hook106(  boolean wasCleaned) throws DatabaseException {
    ...
    hook106__wrappee__base(wasCleaned);
  }

	
   private void  hook107__wrappee__base  (  boolean wasCleaned) throws DatabaseException {
  }
  ...
  protected void hook107(  boolean wasCleaned) throws DatabaseException {
    ...
    hook107__wrappee__base(wasCleaned);
  }

	
   private void  hook108__wrappee__base  (  boolean wasCleaned) throws DatabaseException {
  }
  ...
  protected void hook108(  boolean wasCleaned) throws DatabaseException {
    ...
    hook108__wrappee__base(wasCleaned);
  }

	
   private void  hook109__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook109() throws DatabaseException {
    nLNsMigrated++;
    hook109__wrappee__base();
  }

	
   private void  hook110__wrappee__base  (  boolean wasCleaned) throws DatabaseException {
  }
  ...
  protected void hook110(  boolean wasCleaned) throws DatabaseException {
    ...
    hook110__wrappee__base(wasCleaned);
  }

	
   private void  hook111__wrappee__base  (  boolean wasCleaned) throws DatabaseException {
  }
  ...
  protected void hook111(  boolean wasCleaned) throws DatabaseException {
    ...
    hook111__wrappee__base(wasCleaned);
  }

	
   private boolean  hook112__wrappee__base  (  DatabaseImpl db,  boolean c) throws DatabaseException {
    return c;
  }
  ...
  protected boolean hook112(  DatabaseImpl db,  boolean c) throws DatabaseException {
    c=c || db.isDeleted();
    return hook112__wrappee__base(db,c);
  }

	
   private void  hook113__wrappee__base  (  DatabaseImpl db) throws DatabaseException {
  }

	
  protected void hook113(  DatabaseImpl db) throws DatabaseException {
    addPendingDB(db);
    hook113__wrappee__base(db);
  }
...
@MethodObject static  class  Cleaner_trace {
    ...
    Cleaner_trace(    Cleaner _this,    Level level,    String action,    Node node,    long logLsn,    boolean completed,    boolean obsolete,    boolean dirtiedMigrated){
     ...
     private void  execute__wrappee__LoggingCleaner  (){
    }
    ...
    void execute(){
      ...
      execute__wrappee__LoggingCleaner();
    }
