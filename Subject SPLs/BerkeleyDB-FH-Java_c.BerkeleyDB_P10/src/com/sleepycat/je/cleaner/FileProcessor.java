...
@MethodObject static  class  FileProcessor_processFile {
    ...
    protected DatabaseImpl db;
     ...
     private void  hook119__wrappee__base  () throws DatabaseException, IOException {
    }
    ...
    protected void hook119() throws DatabaseException, IOException {
      ...
      hook119__wrappee__base();
    }

		
     private void  hook120__wrappee__base  () throws DatabaseException, IOException {
    }
    ...
    protected void hook137() throws DatabaseException, IOException {
     ...
     private void  hook145__wrappee__base  () throws DatabaseException, IOException {
    }
    ...
    protected void hook145() throws DatabaseException, IOException {
      ...
      hook145__wrappee__base();
    }

		
     private void  hook146__wrappee__base  () throws DatabaseException, IOException {
    }

		
    protected void hook146() throws DatabaseException, IOException {
      _this.cleaner.nEntriesRead+=1;
      hook146__wrappee__base();
    }

		
     private void  hook147__wrappee__base  () throws DatabaseException, IOException {
    }
    ...
    protected void hook147() throws DatabaseException, IOException {
      ...
      hook147__wrappee__base();
    }

		
     private void  hook154__wrappee__base  () throws DatabaseException, IOException {
    }

		
    protected void hook154() throws DatabaseException, IOException {
      checkPendingDbSet=new HashSet();
      hook154__wrappee__base();
    }

		
     private void  hook155__wrappee__base  () throws DatabaseException, IOException {
    }
    ...
    protected void hook155() throws DatabaseException, IOException {
      ...
      hook155__wrappee__base();
    }

		
     private void  hook156__wrappee__base  () throws DatabaseException, IOException {
    }
    ...
    protected void hook156() throws DatabaseException, IOException {
      ...
      hook156__wrappee__base();
    }

		
     private void  hook161__wrappee__base  () throws DatabaseException, IOException {
    }
      ...
      budget=_this.env.getMemoryBudget();
{
     ...
     private void  hook162__wrappee__base  () throws DatabaseException, IOException {
    }
        ...
        isDupCountLN=ln.containsDuplicates();
{
    ...
    protected LNInfo myInfo;
     ...
     private void  hook126__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook133() throws DatabaseException {
     ...
     private void  hook135__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook135() throws DatabaseException {
      ...
      hook135__wrappee__base();
    }

		
     private void  hook148__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook148() throws DatabaseException {
      _this.nLNsDeadThisRun++;
      hook148__wrappee__base();
    }

		
     private void  hook149__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook149() throws DatabaseException {
      _this.nLNsDeadThisRun++;
      hook149__wrappee__base();
    }

		
     private void  hook150__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook150() throws DatabaseException {
      _this.nLNsDeadThisRun++;
      hook150__wrappee__base();
    }

		
     private void  hook157__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook157() throws DatabaseException {
      b|=db.isDeleted();
      hook157__wrappee__base();
    }

		
     private void  hook158__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook158() throws DatabaseException {
      _this.cleaner.addPendingDB(db);
      hook158__wrappee__base();
    }
  ...
  protected void hook123(  String traceMsg) throws DatabaseException {
   ...
   private void  hook124__wrappee__base  (  long logLsn,  LN ln,  boolean obsolete,  boolean migrated,  boolean completed) throws DatabaseException {
  }
  ...
  protected void hook124(  long logLsn,  LN ln,  boolean obsolete,  boolean migrated,  boolean completed) throws DatabaseException {
    ...
    hook124__wrappee__base(logLsn,ln,obsolete,migrated,completed);
  }

	
   private void  hook125__wrappee__base  (  IN inClone,  DatabaseImpl db,  long lsn,  boolean obsolete,  boolean dirtied,  boolean completed) throws DatabaseException {
    boolean b=db == null;
    b=this.hook159(db,b);
    if (b) {
      this.hook160(db);
   ...
   private void  hook125__wrappee__Statistics  (  IN inClone,  DatabaseImpl db,  long lsn,  boolean obsolete,  boolean dirtied,  boolean completed) throws DatabaseException {
    nINsCleanedThisRun++;
    hook125__wrappee__base(inClone,db,lsn,obsolete,dirtied,completed);
  }
  ...
  protected void hook125(  IN inClone,  DatabaseImpl db,  long lsn,  boolean obsolete,  boolean dirtied,  boolean completed) throws DatabaseException {
    try {
      hook125__wrappee__Statistics(inClone,db,lsn,obsolete,dirtied,completed);
    }
  finally {
   ...
   private void  hook134__wrappee__base  (  Tree tree,  DatabaseImpl db,  IN inClone,  long lsn,  SearchResult result) throws DatabaseException {
  ...
  protected void hook134(  Tree tree,  DatabaseImpl db,  IN inClone,  long lsn,  SearchResult result) throws DatabaseException {
    try {
      hook134__wrappee__base(tree,db,inClone,lsn,result);
    }
  finally {
   ...
   private void  hook136__wrappee__base  (  IN inInTree) throws DatabaseException {
  }

	
  protected void hook136(  IN inInTree) throws DatabaseException {
    inInTree.releaseLatch();
    hook136__wrappee__base(inInTree);
  }

	
   private void  hook138__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook138() throws DatabaseException {
    resetPerRunCounters();
    hook138__wrappee__base();
  }

	
   private String  hook139__wrappee__base  (  String traceMsg) throws DatabaseException, IOException {
    return traceMsg;
  }
  ...
  protected String hook139(  String traceMsg) throws DatabaseException, IOException {
    ...
    return hook139__wrappee__base(traceMsg);
  }

	
   private void  hook140__wrappee__base  () throws DatabaseException, IOException {
  }

	
  protected void hook140() throws DatabaseException, IOException {
    accumulatePerRunCounters();
    hook140__wrappee__base();
  }

	
   private String  hook141__wrappee__base  (  String traceMsg) throws DatabaseException {
    return traceMsg;
  }
  ...
  protected String hook141(  String traceMsg) throws DatabaseException {
    ...
    return hook141__wrappee__base(traceMsg);
  }

	
   private void  hook142__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook142() throws DatabaseException {
    nLNsLockedThisRun++;
    hook142__wrappee__base();
  }

	
   private void  hook143__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook143() throws DatabaseException {
   ...
   private void  hook144__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook144() throws DatabaseException {
   ...
   private void  hook151__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook151() throws DatabaseException {
   ...
   private void  hook152__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook152() throws DatabaseException {
   ...
   private void  hook153__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook153() throws DatabaseException {
   ...
   private boolean  hook159__wrappee__base  (  DatabaseImpl db,  boolean b) throws DatabaseException {
    return b;
  }
  ...
  protected boolean hook159(  DatabaseImpl db,  boolean b) throws DatabaseException {
    b|=db.isDeleted();
    return hook159__wrappee__base(db,b);
  }

	
   private void  hook160__wrappee__base  (  DatabaseImpl db) throws DatabaseException {
  }

	
  protected void hook160(  DatabaseImpl db) throws DatabaseException {
    cleaner.addPendingDB(db);
    hook160__wrappee__base(db);
  }
