...
synchronized (_this) {
    ...
    protected MemoryBudget mb;
     ...
     private void  hook192__wrappee__base  () throws DatabaseException {
    }
...
@MethodObject static  class  UtilizationProfile_putFileSummary {
    ...
    protected MemoryBudget mb;
     ...
     private void  hook193__wrappee__base  () throws DatabaseException {
    }
...
@MethodObject static  class  UtilizationProfile_populateCache {
    ...
    protected MemoryBudget mb;
     ...
     private void  hook176__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook176() throws DatabaseException {
      _this.env.getEvictor().doCriticalEviction();
      hook176__wrappee__base();
    }

		
     private void  hook181__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook181() throws DatabaseException {
      cursor.releaseBIN();
      hook181__wrappee__base();
    }

		
     private void  hook182__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook182() throws DatabaseException {
     ...
     private void  hook183__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook183() throws DatabaseException {
     ...
     private void  hook184__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook184() throws DatabaseException {
     ...
     private void  hook185__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook185() throws DatabaseException {
     ...
     private void  hook191__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook191() throws DatabaseException {
     ...
     private void  hook194__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook194() throws DatabaseException {
      ...
      hook194__wrappee__base();
    }

		
     private void  hook195__wrappee__base  () throws DatabaseException {
    }
   ...
   private void  hook173__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook173() throws DatabaseException {
    env.getEvictor().doCriticalEviction();
    hook173__wrappee__base();
  }

	
   private void  hook174__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook174() throws DatabaseException {
   ...
   private void  hook175__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook177(  long fileNum,  int sequence,  OperationStatus status) throws DatabaseException {
   ...
   private void  hook178__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }

	
  protected void hook178(  CursorImpl cursor) throws DatabaseException {
    cursor.releaseBINs();
    hook178__wrappee__base(cursor);
  }

	
   private void  hook179__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }
  ...
  protected void hook179(  CursorImpl cursor) throws DatabaseException {
    ...
    hook179__wrappee__base(cursor);
  }

	
   private void  hook180__wrappee__base  (  long lsn,  LNLogEntry entry,  DatabaseImpl db,  BIN bin) throws DatabaseException {
  ...
  protected void hook180(  long lsn,  LNLogEntry entry,  DatabaseImpl db,  BIN bin) throws DatabaseException {
    try {
      hook180__wrappee__base(lsn,entry,db,bin);
    }
  finally {
      if (bin != null) {
        bin.releaseLatch();
   ...
   private boolean  hook186__wrappee__base  (  DatabaseImpl db,  boolean b) throws DatabaseException {
    return b;
  }
  ...
  protected boolean hook186(  DatabaseImpl db,  boolean b) throws DatabaseException {
    b|=db.isDeleted();
    return hook186__wrappee__base(db,b);
  }

	
   private void  hook187__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }

	
  protected void hook187(  CursorImpl cursor) throws DatabaseException {
    cursor.evict();
    hook187__wrappee__base(cursor);
  }

	
   private void  hook188__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }

	
  protected void hook188(  CursorImpl cursor) throws DatabaseException {
    cursor.evict();
    hook188__wrappee__base(cursor);
  }

	
   private void  hook189__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }

	
  protected void hook189(  CursorImpl cursor) throws DatabaseException {
    cursor.setAllowEviction(false);
    hook189__wrappee__base(cursor);
  }

	
   private void  hook190__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }

	
  protected void hook190(  CursorImpl cursor) throws DatabaseException {
    cursor.evict();
    hook190__wrappee__base(cursor);
  }
