 ...
 */
   private CursorImpl  cloneCursor__wrappee__base  (  boolean addCursor,  CursorImpl usePosition) throws DatabaseException {
    CursorImpl ret=null;
    if (nonCloning) {
      ret=this;
    }
 ...
 */
  public CursorImpl cloneCursor(  boolean addCursor,  CursorImpl usePosition) throws DatabaseException {
    CursorImpl result=cloneCursor__wrappee__base(addCursor,usePosition);
    if (allowEviction) {
      this.hook203();
    }
    return result;
 ...
 * be used further.
 */
   private void  reset__wrappee__base  () throws DatabaseException {
    removeCursor();
    if (!retainNonTxnLocks) {
 ...
 */
   private void  close__wrappee__base  () throws DatabaseException {
 ...
 */
  public KeyChangeStatus getNextWithKeyChangeStatus(  DatabaseEntry foundKey,  DatabaseEntry foundData,  LockType lockType,  boolean forward,  boolean alreadyLatched) throws DatabaseException {
   ...
   private void  flushBINToBeRemoved__wrappee__base  () throws DatabaseException {
  ...
  private void flushBINToBeRemoved() throws DatabaseException {
    ...
    flushBINToBeRemoved__wrappee__base();
  }
 ...
 */
  public OperationStatus getNextDuplicate(  DatabaseEntry foundKey,  DatabaseEntry foundData,  LockType lockType,  boolean forward,  boolean alreadyLatched) throws DatabaseException {
   ...
   private void  flushDBINToBeRemoved__wrappee__base  () throws DatabaseException {
  ...
  private void flushDBINToBeRemoved() throws DatabaseException {
    ...
    flushDBINToBeRemoved__wrappee__base();
  }
...
protected BIN waitingOn;
 ...
 private void  hook244__wrappee__base  () throws DatabaseException {
this.hook245();
}
    ...
    protected void hook244() throws DatabaseException {
      while (_this.bin != null) {
        hook244__wrappee__base();
      }
      throw new ReturnObject(null);
    }

		
 private void  hook245__wrappee__base  () throws DatabaseException {
...
protected BIN waitingOn;
 ...
 private void  hook246__wrappee__base  () throws DatabaseException {
this.hook247();
}
    ...
    protected void hook246() throws DatabaseException {
      while (_this.dupBin != null) {
        hook246__wrappee__base();
      }
      throw new ReturnObject(null);
    }

		
 private void  hook247__wrappee__base  () throws DatabaseException {
...
protected OperationStatus status;
 ...
 private void  hook248__wrappee__base  () throws DatabaseException {
...
this.hook249();
 ...
 private void  hook249__wrappee__base  () throws DatabaseException {
}

		
    protected void hook249() throws DatabaseException {
      latched=false;
      hook249__wrappee__base();
    }
...
protected DBIN newDupBin;
 ...
 private void  hook250__wrappee__base  () throws DatabaseException {
}

		
    protected void hook250() throws DatabaseException {
      assert _this.checkAlreadyLatched(alreadyLatched) : _this.dumpToString(true);
      hook250__wrappee__base();
    }

		
 private void  hook251__wrappee__base  () throws DatabaseException {
}
 ...
 private void  hook252__wrappee__base  () throws DatabaseException {
}
 ...
 private void  hook253__wrappee__base  () throws DatabaseException {
}
 ...
 private void  hook254__wrappee__base  () throws DatabaseException {
}
 ...
 private void  hook255__wrappee__base  () throws DatabaseException {
}
 ...
 private void  hook256__wrappee__base  () throws DatabaseException {
}
 ...
 private void  hook257__wrappee__base  () throws DatabaseException {
}
 ...
 private void  hook275__wrappee__base  () throws DatabaseException {
}
    ...
    protected void hook275() throws DatabaseException {
      ...
      hook275__wrappee__base();
    }

		
 private void  hook279__wrappee__base  () throws DatabaseException {
}
    ...
    protected void hook279() throws DatabaseException {
      ...
      hook279__wrappee__base();
    }

		
     private void  hook200__wrappee__Statistics  () throws DatabaseException {
      if (_this.index < 0) {
    ...
    protected void hook200() throws DatabaseException {
     ...
     private void  hook201__wrappee__Statistics  () throws DatabaseException {
...
protected byte[] lnData;
 ...
 private void  hook258__wrappee__base  () throws DatabaseException {
ln=lockResult.getLN();
...
throw new ReturnObject(OperationStatus.SUCCESS);
 ...
 private void  hook259__wrappee__base  () throws DatabaseException {
}

		
    protected void hook259() throws DatabaseException {
      assert _this.targetBin.isLatchOwner();
      hook259__wrappee__base();
    }

		
 private void  hook260__wrappee__base  () throws DatabaseException {
n=_this.targetBin.fetchTarget(_this.targetIndex);
 ...
 private void  hook261__wrappee__base  () throws DatabaseException {
}

		
    protected void hook261() throws DatabaseException {
      _this.targetBin.releaseLatchIfOwner();
      hook261__wrappee__base();
    }

		
 private void  hook262__wrappee__base  () throws DatabaseException {
}
    ...
    protected void hook262() throws DatabaseException {
      ...
      hook262__wrappee__base();
    }

		
 private void  hook263__wrappee__base  () throws DatabaseException {
throw new ReturnObject(_this.fetchCurrent(foundKey,foundData,lockType,first));
 ...
 private void  hook280__wrappee__base  () throws DatabaseException {
}
...
protected void hook205(LN ln,long oldLsn,long newLsn) throws DatabaseException {
 ...
 private void  hook206__wrappee__base  () throws DatabaseException, CloneNotSupportedException {
}

	
  protected void hook206() throws DatabaseException, CloneNotSupportedException {
    latchBINs();
    hook206__wrappee__base();
  }

	
 private void  hook207__wrappee__base  () throws DatabaseException {
}

	
  protected void hook207() throws DatabaseException {
    releaseBINs();
    hook207__wrappee__base();
  }

	
 private void  hook208__wrappee__base  (BIN bin){
}

	
  protected void hook208(  BIN bin){
    assert bin.isLatchOwner();
    hook208__wrappee__base(bin);
  }

	
 private void  hook209__wrappee__base  (BIN abin) throws DatabaseException {
}

	
  protected void hook209(  BIN abin) throws DatabaseException {
    abin.releaseLatch();
    hook209__wrappee__base(abin);
  }

	
 private void  hook210__wrappee__base  (DBIN abin) throws DatabaseException {
}

	
  protected void hook210(  DBIN abin) throws DatabaseException {
    abin.releaseLatch();
    hook210__wrappee__base(abin);
  }

	
 private void  hook211__wrappee__base  () throws DatabaseException {
}

	
  protected void hook211() throws DatabaseException {
    dupBin.releaseLatch();
    hook211__wrappee__base();
  }

	
 private void  hook212__wrappee__base  (LockType lockType) throws DatabaseException {
...
throw new ReturnInt(1);
  ...
  protected void hook212(  LockType lockType) throws DatabaseException {
    latchBIN();
    try {
      hook212__wrappee__base(lockType);
    }
  finally {
      releaseBIN();
    }
 ...
 private void  hook213__wrappee__base  (boolean isDup,LN ln,LockResult lockResult,LockResult dclLockResult,DIN dupRoot) throws DatabaseException {
isDup=(dupBin != null);
if (isDup) {
...
this.hook204(ln,oldLsn,newLsn);
  ...
  protected void hook213(  boolean isDup,  LN ln,  LockResult lockResult,  LockResult dclLockResult,  DIN dupRoot) throws DatabaseException {
    try {
      hook213__wrappee__base(isDup,ln,lockResult,dclLockResult,dupRoot);
    }
  finally {
      if (dupRoot != null) {
 ...
 private void  hook214__wrappee__base  () throws DatabaseException {
}

	
  protected void hook214() throws DatabaseException {
    releaseBINs();
    hook214__wrappee__base();
  }

	
 private void  hook215__wrappee__base  () throws DatabaseException {
}

	
  protected void hook215() throws DatabaseException {
    releaseBINs();
    hook215__wrappee__base();
  }

	
 private void  hook216__wrappee__base  () throws DatabaseException {
}

	
  protected void hook216() throws DatabaseException {
    releaseBINs();
    hook216__wrappee__base();
  }

	
 private void  hook217__wrappee__base  () throws DatabaseException {
}

	
  protected void hook217() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook217__wrappee__base();
  }

	
 private void  hook218__wrappee__base  (DatabaseEntry data,DatabaseEntry foundKey,DatabaseEntry foundData,boolean isDup) throws DatabaseException {
LN ln=(LN)targetBin.fetchTarget(targetIndex);
byte[] lnKey=targetBin.getKey(targetIndex);
...
throw new ReturnObject(OperationStatus.SUCCESS);
  ...
  protected void hook218(  DatabaseEntry data,  DatabaseEntry foundKey,  DatabaseEntry foundData,  boolean isDup) throws DatabaseException {
    try {
      hook218__wrappee__base(data,foundKey,foundData,isDup);
    }
  finally {
      releaseBINs();
    }
 ...
 private void  hook219__wrappee__base  () throws DatabaseException {
}

	
  protected void hook219() throws DatabaseException {
    latchBINs();
    hook219__wrappee__base();
  }

	
 private void  hook220__wrappee__base  () throws DatabaseException {
}
  ...
  protected void hook220() throws DatabaseException {
    ...
    hook220__wrappee__base();
  }

	
 private void  hook221__wrappee__base  (DatabaseEntry foundKey,DatabaseEntry foundData,LockType lockType,boolean first) throws DatabaseException {
throw new ReturnObject(fetchCurrent(foundKey,foundData,lockType,first));
  ...
  protected void hook221(  DatabaseEntry foundKey,  DatabaseEntry foundData,  LockType lockType,  boolean first) throws DatabaseException {
    ...
    try {
      hook221__wrappee__base(foundKey,foundData,lockType,first);
    }
  finally {
      releaseBINs();
    }
 ...
 private void  hook222__wrappee__base  () throws DatabaseException {
}

	
  protected void hook222() throws DatabaseException {
    latchBIN();
    hook222__wrappee__base();
  }

	
 private void  hook223__wrappee__base  (LockType lockType) throws DatabaseException {
assert assertCursorState(true) : dumpToString(true);
this.hook272();
if (bin == null) {
throw new ReturnObject(null);
...
throw new ReturnObject(ln);
  ...
  protected void hook223(  LockType lockType) throws DatabaseException {
    try {
      hook223__wrappee__base(lockType);
    }
  finally {
      releaseBINs();
    }
 ...
 private void  hook224__wrappee__base  (boolean alreadyLatched) throws DatabaseException {
}
  ...
  protected void hook224(  boolean alreadyLatched) throws DatabaseException {
    ...
    hook224__wrappee__base(alreadyLatched);
  }

	
 private boolean  hook225__wrappee__base  (boolean alreadyLatched) throws DatabaseException {
return alreadyLatched;
  ...
  protected boolean hook225(  boolean alreadyLatched) throws DatabaseException {
    ...
    return hook225__wrappee__base(alreadyLatched);
  }

	
 private boolean  hook226__wrappee__base  (boolean alreadyLatched) throws DatabaseException {
return alreadyLatched;
}
  ...
  protected boolean hook226(  boolean alreadyLatched) throws DatabaseException {
    alreadyLatched=false;
    return hook226__wrappee__base(alreadyLatched);
  }

	
 private void  hook227__wrappee__base  () throws DatabaseException {
}

	
  protected void hook227() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0;
    hook227__wrappee__base();
  }

	
 private void  hook228__wrappee__base  () throws DatabaseException {
}

	
  protected void hook228() throws DatabaseException {
    latchBIN();
    hook228__wrappee__base();
  }

	
 private void  hook229__wrappee__base  () throws DatabaseException {
}

	
  protected void hook229() throws DatabaseException {
    releaseBIN();
    hook229__wrappee__base();
  }

	
 private void  hook230__wrappee__base  (boolean alreadyLatched) throws DatabaseException {
}

	
  protected void hook230(  boolean alreadyLatched) throws DatabaseException {
    alreadyLatched=true;
    hook230__wrappee__base(alreadyLatched);
  }

	
 private void  hook231__wrappee__base  () throws DatabaseException {
}

	
  protected void hook231() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 0 : LatchSupport.latchesHeldToString();
    hook231__wrappee__base();
  }

	
 private void  hook232__wrappee__base  () throws DatabaseException {
}

	
  protected void hook232() throws DatabaseException {
    binToBeRemoved.releaseLatch();
    hook232__wrappee__base();
  }

	
 private void  hook233__wrappee__base  () throws DatabaseException {
}

	
  protected void hook233() throws DatabaseException {
    dupBinToBeRemoved.releaseLatch();
    hook233__wrappee__base();
  }

	
 private void  hook234__wrappee__base  (boolean first,DIN duplicateRoot,IN in,boolean found) throws DatabaseException {
...
throw new ReturnBoolean(found);
  ...
  protected void hook234(  boolean first,  DIN duplicateRoot,  IN in,  boolean found) throws DatabaseException {
    try {
      hook234__wrappee__base(first,duplicateRoot,in,found);
    }
 catch (    DatabaseException e) {
      if (in != null) {
        in.releaseLatch();
 ...
 private void  hook235__wrappee__base  (DatabaseEntry matchKey,DatabaseEntry matchData,SearchMode searchMode,LockType lockType,boolean foundSomething,boolean foundExactKey,boolean foundExactData,boolean foundLast,boolean exactSearch,BINBoundary binBoundary) throws DatabaseException {
...
throw new ReturnInt((foundSomething ? FOUND : 0) | (foundExactKey ? EXACT_KEY : 0) | (foundExactData ? EXACT_DATA : 0)| (foundLast ? FOUND_LAST : 0));
  ...
  protected void hook235(  DatabaseEntry matchKey,  DatabaseEntry matchData,  SearchMode searchMode,  LockType lockType,  boolean foundSomething,  boolean foundExactKey,  boolean foundExactData,  boolean foundLast,  boolean exactSearch,  BINBoundary binBoundary) throws DatabaseException {
    try {
      hook235__wrappee__base(matchKey,matchData,searchMode,lockType,foundSomething,foundExactKey,foundExactData,foundLast,exactSearch,binBoundary);
    }
 catch (    DatabaseException e) {
      releaseBIN();
      throw e;
 ...
 private void  hook236__wrappee__base  (DIN duplicateRoot) throws DatabaseException {
}
  ...
  protected void hook236(  DIN duplicateRoot) throws DatabaseException {
    duplicateRoot.latch();
    releaseBIN();
    hook236__wrappee__base(duplicateRoot);
  }

	
 private void  hook237__wrappee__base  () throws DatabaseException {
}

	
  protected void hook237() throws DatabaseException {
    latchBINs();
    hook237__wrappee__base();
  }

	
 private void  hook238__wrappee__base  () throws DatabaseException {
}

	
  protected void hook238() throws DatabaseException {
    releaseBINs();
    hook238__wrappee__base();
  }

	
 private void  hook239__wrappee__base  (DIN dupRoot) throws DatabaseException {
}
  ...
  protected void hook239(  DIN dupRoot) throws DatabaseException {
    dupRoot.latch();
    latchDBIN();
    hook239__wrappee__base(dupRoot);
  }

	
 private void  hook240__wrappee__base  () throws DatabaseException {
}

	
  protected void hook240() throws DatabaseException {
    latchBIN();
    hook240__wrappee__base();
  }

	
 private void  hook241__wrappee__base  (DIN dupRoot) throws DatabaseException {
}
  ...
  protected void hook241(  DIN dupRoot) throws DatabaseException {
    ...
    releaseBINs();
    hook241__wrappee__base(dupRoot);
  }

	
 private void  hook242__wrappee__base  (boolean isDBINLatched,DIN dupRoot) throws DatabaseException {
}
  ...
  protected void hook242(  boolean isDBINLatched,  DIN dupRoot) throws DatabaseException {
    ...
    hook242__wrappee__base(isDBINLatched,dupRoot);
  }

	
 private void  hook243__wrappee__base  () throws DatabaseException {
}

	
  protected void hook243() throws DatabaseException {
    assert bin.isLatchOwner();
    hook243__wrappee__base();
  }

	
 private void  hook264__wrappee__base  (DIN dupRoot) throws DatabaseException {
}

	
  protected void hook264(  DIN dupRoot) throws DatabaseException {
    dupRoot.releaseLatch();
    hook264__wrappee__base(dupRoot);
  }

	
 private void  hook265__wrappee__base  (DIN dupRoot) throws DatabaseException {
}
  ...
  protected void hook265(  DIN dupRoot) throws DatabaseException {
    dupRoot.latch();
    releaseBIN();
    hook265__wrappee__base(dupRoot);
  }

	
 private void  hook266__wrappee__base  () throws DatabaseException {
}

	
  protected void hook266() throws DatabaseException {
    releaseBINs();
    hook266__wrappee__base();
  }

	
 private void  hook267__wrappee__base  () throws DatabaseException {
}

	
  protected void hook267() throws DatabaseException {
    releaseBIN();
    hook267__wrappee__base();
  }

	
 private void  hook268__wrappee__base  (DIN dupRoot) throws DatabaseException {
}

	
  protected void hook268(  DIN dupRoot) throws DatabaseException {
    dupRoot.releaseLatch();
    hook268__wrappee__base(dupRoot);
  }

	
 private void  hook269__wrappee__base  () throws DatabaseException {
}

	
  protected void hook269() throws DatabaseException {
    releaseBINs();
    hook269__wrappee__base();
  }

	
 private void  hook270__wrappee__base  () throws DatabaseException {
}

	
  protected void hook270() throws DatabaseException {
    releaseBINs();
    hook270__wrappee__base();
  }

	
 private void  hook271__wrappee__base  () throws DatabaseException {
}

	
  protected void hook271() throws DatabaseException {
    releaseBINs();
    hook271__wrappee__base();
  }

	
 private void  hook272__wrappee__base  () throws DatabaseException {
}

	
  protected void hook272() throws DatabaseException {
    assert checkAlreadyLatched(true) : dumpToString(true);
    hook272__wrappee__base();
  }

	
 private void  hook273__wrappee__base  () throws DatabaseException {
}

	
  protected void hook273() throws DatabaseException {
    releaseBIN();
    hook273__wrappee__base();
  }

	
 private void  hook274__wrappee__base  (IN in,DIN dupRoot) throws DatabaseException {
}
  ...
  protected void hook274(  IN in,  DIN dupRoot) throws DatabaseException {
    dupRoot.latch();
    in.releaseLatch();
    hook274__wrappee__base(in,dupRoot);
  }

	
 private void  hook276__wrappee__base  () throws DatabaseException {
}
  ...
  protected void hook276() throws DatabaseException {
    ...
    hook276__wrappee__base();
  }

	
 private void  hook277__wrappee__base  () throws DatabaseException {
}
  ...
  protected void hook277() throws DatabaseException {
    ...
    hook277__wrappee__base();
  }

	
 private void  hook278__wrappee__base  () throws DatabaseException {
}
  ...
  protected void hook278() throws DatabaseException {
    ...
    hook278__wrappee__base();
  }

	
 private void  hook281__wrappee__base  (byte[] lnKey) throws DatabaseException {
}

	
  protected void hook281(  byte[] lnKey) throws DatabaseException {
    locker.addDeleteInfo(dupBin,new Key(lnKey));
    hook281__wrappee__base(lnKey);
  }

	
 private void  hook282__wrappee__base  (byte[] lnKey) throws DatabaseException {
}

	
  protected void hook282(  byte[] lnKey) throws DatabaseException {
    locker.addDeleteInfo(bin,new Key(lnKey));
    hook282__wrappee__base(lnKey);
  }

	
 private long  hook283__wrappee__base  (LN ln,long newLNSize) throws DatabaseException {
return newLNSize;
}
  ...
  protected long hook283(  LN ln,  long newLNSize) throws DatabaseException {
    ...
    return hook283__wrappee__base(ln,newLNSize);
  }

	
 private long  hook284__wrappee__base  (LN ln,long oldLNSize) throws DatabaseException {
return oldLNSize;
}
  ...
  protected long hook284(  LN ln,  long oldLNSize) throws DatabaseException {
    ...
    return hook284__wrappee__base(ln,oldLNSize);
  }

	
 private long  hook285__wrappee__base  (LN ln,long newLNSize) throws DatabaseException {
return newLNSize;
}
  ...
  protected long hook285(  LN ln,  long newLNSize) throws DatabaseException {
    newLNSize=ln.getMemorySizeIncludedByParent();
    return hook285__wrappee__base(ln,newLNSize);
  }

	
 private long  hook286__wrappee__base  (LN ln,long oldLNSize) throws DatabaseException {
return oldLNSize;
}
  ...
  protected long hook286(  LN ln,  long oldLNSize) throws DatabaseException {
    oldLNSize=ln.getMemorySizeIncludedByParent();
    return hook286__wrappee__base(ln,oldLNSize);
  }
 ...
 * databases only.
 */
   private void  evict__wrappee__Evictor  () throws DatabaseException {
    this.hook202();
    setTargetBin();
 ...
 */
  public void evict() throws DatabaseException {
   ...
   private void  hook202__wrappee__Evictor  () throws DatabaseException {
  }

	
  protected void hook202() throws DatabaseException {
    latchBINs();
    hook202__wrappee__Evictor();
  }

	
   private void  hook203__wrappee__Evictor  () throws DatabaseException {
  }

	
  protected void hook203() throws DatabaseException {
    database.getDbEnvironment().getEvictor().doCriticalEviction();
    hook203__wrappee__Evictor();
  }
