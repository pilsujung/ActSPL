...
@MethodObject static  class  EnvironmentImpl_createDaemons {
   ...
   private void  hook317__wrappee__base  (  DbConfigManager mgr) throws DatabaseException {
  }
  ...
  protected void hook324(  long rootLsn) throws DatabaseException {
   ...
   private void  hook325__wrappee__base  (  StringBuffer errors) throws DatabaseException {
  }
  ...
  protected void hook325(  StringBuffer errors) throws DatabaseException {
    ...
    hook325__wrappee__base(errors);
  }

	
   private void  hook326__wrappee__base  (  DbConfigManager mgr) throws DatabaseException {
  }
  ...
  protected void hook326(  DbConfigManager mgr) throws DatabaseException {
    ...
    hook326__wrappee__base(mgr);
  }

	
   private void  hook327__wrappee__base  (){
  }
  ...
  protected void hook327(){
   ...
   private void  hook328__wrappee__base  () throws InterruptedException {
  }
 ...
 */
  private void checkLeaks() throws DatabaseException {
   ...
   private void  hook311__wrappee__CheckLeaks  () throws DatabaseException {
  }
...
@MethodObject static  class  EnvironmentImpl_checkLeaks {
    ...
    protected TransactionStats.Active[] active;
     ...
     private void  hook312__wrappee__CheckLeaks  () throws DatabaseException {
    }
    ...
    protected void hook312() throws DatabaseException {
     ...
     private void  hook313__wrappee__CheckLeaks  () throws DatabaseException {
    }
 ...
 */
  synchronized public TransactionStats txnStat(  StatsConfig config) throws DatabaseException {
   ...
   private void  hook314__wrappee__Statistics  (  StatsConfig config,  EnvironmentStats stats) throws DatabaseException {
  }
  ...
  //  inCompressor.loadStats(config,stats);
    hook314__wrappee__Statistics(config,stats);
  }

	
   private void  hook315__wrappee__Statistics  (  StatsConfig config,  EnvironmentStats stats) throws DatabaseException {
  }

	
  protected void hook315(  StatsConfig config,  EnvironmentStats stats) throws DatabaseException {
    evictor.loadStats(config,stats);
    hook315__wrappee__Statistics(config,stats);
  }

	
   private void  hook316__wrappee__Statistics  (  StatsConfig config,  EnvironmentStats stats) throws DatabaseException {
  }
  ...
  protected void hook316(  StatsConfig config,  EnvironmentStats stats) throws DatabaseException {
    ...
    hook316__wrappee__Statistics(config,stats);
  }
