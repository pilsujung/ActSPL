...
@MethodObject static  class  DbCacheSize_insertRecords {
    ...
    protected EnvironmentStats stats;
     ...
     private void  hook833__wrappee__MemoryBudget  () throws DatabaseException {
    }
    ...
    //    out.println("*** Ran out of cache memory at record " + i + " -- try increasing the Java heap size ***");
      ...
      hook833__wrappee__MemoryBudget();
    }
   ...
   private static void  hook831__wrappee__MemoryBudget  (  PrintStream out,  Environment env) throws DatabaseException {
  }
  ...
  protected static void hook831(  PrintStream out,  Environment env) throws DatabaseException {
    ...
    hook831__wrappee__MemoryBudget(out,env);
  }

	
   private static void  hook832__wrappee__MemoryBudget  (  PrintStream out,  Environment env) throws DatabaseException {
  }
  ...
  protected static void hook832(  PrintStream out,  Environment env) throws DatabaseException {
    ...
    hook832__wrappee__MemoryBudget(out,env);
  }
