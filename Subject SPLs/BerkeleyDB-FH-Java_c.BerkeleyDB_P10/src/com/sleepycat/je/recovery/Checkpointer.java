...
@MethodObject static  class  Checkpointer_getWakeupPeriod {
    ...
    Checkpointer_getWakeupPeriod(    DbConfigManager configManager){
     ...
     private long  execute__wrappee__base  () throws IllegalArgumentException, DatabaseException {
      this.hook541();
      this.hook519();
      result=0;
      this.hook540();
    ...
    protected int result;
     ...
     private void  hook519__wrappee__base  () throws IllegalArgumentException, DatabaseException {
    }
    ...
    protected void hook519() throws IllegalArgumentException, DatabaseException {
      ...
      hook519__wrappee__base();
    }

		
     private void  hook540__wrappee__base  () throws IllegalArgumentException, DatabaseException {
    }

		
     private void  hook540__wrappee__CPTime  () throws IllegalArgumentException, DatabaseException {
      result+=wakeupPeriod;
    ...
    protected void hook540() throws IllegalArgumentException, DatabaseException {
      if (bytePeriod == 0) {
        hook540__wrappee__CPTime();
      }
    }

		
     private void  hook541__wrappee__base  () throws IllegalArgumentException, DatabaseException {
    }
...
@MethodObject static  class  Checkpointer_isRunnable {
    ...
    protected void hook521() throws DatabaseException {
     ...
     private void  hook542__wrappee__base  () throws DatabaseException {
      throw new ReturnBoolean(false);
    }

		
     private void  hook542__wrappee__CPTime  () throws DatabaseException {
    ...
    protected void hook542() throws DatabaseException {
      if (useBytesInterval != 0) {
        ...
        hook542__wrappee__CPTime();
      }
    }

		
     private void  hook543__wrappee__base  () throws DatabaseException {
      this.hook544();
    }

		
     private void  hook543__wrappee__CPTime  () throws DatabaseException {
      if (config.getMinutes() != 0) {
        useTimeInterval=config.getMinutes() * 60 * 1000;
      }
 else {
        hook543__wrappee__base();
      }
    }
    ...
    protected void hook543() throws DatabaseException {
      if (config.getKBytes() != 0) {
        ...
        hook543__wrappee__CPTime();
      }
    }

		
     private void  hook544__wrappee__base  () throws DatabaseException {
    }

		
     private void  hook544__wrappee__CPTime  () throws DatabaseException {
      useTimeInterval=_this.timeInterval;
      hook544__wrappee__base();
    }
...
@MethodObject static  class  Checkpointer_doCheckpoint {
    ...
    protected void hook525() throws DatabaseException {
     ...
     private void  hook534__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook534() throws DatabaseException {
      _this.nCheckpoints++;
      hook534__wrappee__base();
    }

		
     private void  hook535__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook535() throws DatabaseException {
      _this.resetPerRunCounters();
      hook535__wrappee__base();
    }

		
     private void  hook536__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook536() throws DatabaseException {
      _this.lastCheckpointStart=checkpointStart;
      hook536__wrappee__base();
    }

		
     private void  hook547__wrappee__base  () throws DatabaseException {
...
synchronized (_this.envImpl.getEvictor()) {
        hook547__wrappee__base();
      }
    }

		
     private void  hook548__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook548() throws DatabaseException {
      dirtyMapMemSize=0;
      hook548__wrappee__base();
    }

		
     private void  hook549__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook549() throws DatabaseException {
      mb.updateMiscMemoryUsage(0 - dirtyMapMemSize);
      hook549__wrappee__base();
    }

		
     private void  hook550__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook550() throws DatabaseException {
      mb.updateMiscMemoryUsage(totalSize);
      hook550__wrappee__base();
    }

		
     private void  hook551__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook551() throws DatabaseException {
      totalSize=0;
      hook551__wrappee__base();
    }

		
     private void  hook552__wrappee__base  () throws DatabaseException {
    }
...
@MethodObject static  class  Checkpointer_selectDirtyINs {
    ...
    protected Set dirtySet;
     ...
     private void  hook528__wrappee__base  () throws DatabaseException {
    ...
    protected void hook528() throws DatabaseException {
     ...
     private void  hook529__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook529() throws DatabaseException {
      inMemINs.latchMajor();
      hook529__wrappee__base();
    }

		
     private void  hook530__wrappee__base  () throws DatabaseException {
      if (in.getDirty()) {
        level=new Integer(in.getLevel());
{
     ...
     private void  hook530__wrappee__MemoryBudget  () throws DatabaseException {
    ...
    protected void hook530() throws DatabaseException {
      try {
        hook530__wrappee__MemoryBudget();
      }
  finally {
        in.releaseLatch();
      }
     ...
     private void  hook553__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook553() throws DatabaseException {
      totalSize=0;
      mb=_this.envImpl.getMemoryBudget();
      hook553__wrappee__base();
    }

		
     private void  hook554__wrappee__base  () throws DatabaseException {
    }
   ...
   private void  hook520__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook520() throws DatabaseException {
    envImpl.getEvictor().doCriticalEviction();
    hook520__wrappee__base();
  }

	
   private void  hook526__wrappee__base  (  CheckpointReference targetRef,  Map dirtyMap,  int currentLevel,  boolean logProvisionally,  boolean allowDeltas,  long checkpointStart,  Tree tree,  SearchResult result,  boolean mustLogParent) throws DatabaseException {
  ...
  protected void hook526(  CheckpointReference targetRef,  Map dirtyMap,  int currentLevel,  boolean logProvisionally,  boolean allowDeltas,  long checkpointStart,  Tree tree,  SearchResult result,  boolean mustLogParent) throws DatabaseException {
    try {
      hook526__wrappee__base(targetRef,dirtyMap,currentLevel,logProvisionally,allowDeltas,checkpointStart,tree,result,mustLogParent);
    }
  finally {
   ...
   private void  hook527__wrappee__base  (  IN target,  IN parent,  boolean allowDeltas,  long checkpointStart,  boolean logProvisionally,  long newLsn,  boolean mustLogParent) throws DatabaseException {
    if (target.getDirty()) {
   ...
   private void  hook527__wrappee__INCompressor  (  IN target,  IN parent,  boolean allowDeltas,  long checkpointStart,  boolean logProvisionally,  long newLsn,  boolean mustLogParent) throws DatabaseException {
    envImpl.lazyCompress(target);
    hook527__wrappee__base(target,parent,allowDeltas,checkpointStart,logProvisionally,newLsn,mustLogParent);
  }
  ...
  protected void hook527(  IN target,  IN parent,  boolean allowDeltas,  long checkpointStart,  boolean logProvisionally,  long newLsn,  boolean mustLogParent) throws DatabaseException {
    try {
      hook527__wrappee__INCompressor(target,parent,allowDeltas,checkpointStart,logProvisionally,newLsn,mustLogParent);
    }
  finally {
      target.releaseLatch();
    }
   ...
   private void  hook531__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook531() throws DatabaseException {
   ...
   private void  hook532__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook532() throws DatabaseException {
   ...
   private void  hook533__wrappee__base  (  IN target) throws DatabaseException {
  }
  ...
  protected void hook533(  IN target) throws DatabaseException {
    ...
    hook533__wrappee__base(target);
  }

	
   private void  hook537__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook537() throws DatabaseException {
   ...
   private void  hook538__wrappee__base  (  EnvironmentImpl envImpl,  long waitTime,  String name) throws DatabaseException {
  }
  ...
  protected void hook538(  EnvironmentImpl envImpl,  long waitTime,  String name) throws DatabaseException {
    ...
    hook538__wrappee__base(envImpl,waitTime,name);
  }

	
   private void  hook539__wrappee__base  (  EnvironmentImpl envImpl) throws DatabaseException {
  }
  ...
  protected void hook539(  EnvironmentImpl envImpl) throws DatabaseException {
    ...
    hook539__wrappee__base(envImpl);
  }

	
   private void  hook545__wrappee__base  (  long waitTime) throws DatabaseException {
  }

	
  protected void hook545(  long waitTime) throws DatabaseException {
    timeInterval=waitTime;
    hook545__wrappee__base(waitTime);
  }

	
   private void  hook546__wrappee__base  (  SortedMap dirtyMap,  boolean allowDeltas,  long checkpointStart,  Integer currentLevel,  boolean logProvisionally,  CheckpointReference targetRef) throws DatabaseException {
  }
  ...
  protected void hook546(  SortedMap dirtyMap,  boolean allowDeltas,  long checkpointStart,  Integer currentLevel,  boolean logProvisionally,  CheckpointReference targetRef) throws DatabaseException {
    ...
    hook546__wrappee__base(dirtyMap,allowDeltas,checkpointStart,currentLevel,logProvisionally,targetRef);
  }
