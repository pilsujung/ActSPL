...
@MethodObject static  class  Evictor_evictBatch {
    ...
    Evictor_evictBatch(    Evictor _this,    String source,    long requiredEvictBytes){
     ...
     private long  execute__wrappee__Derivative_Statistics_Evictor  () throws DatabaseException {
      _this.nNodesSelectedThisRun=0;
      _this.nNodesEvictedThisRun=0;
      return execute__wrappee__Evictor();
    }

		
    long execute() throws DatabaseException {
      long result=execute__wrappee__Derivative_Statistics_Evictor();
    ...
    protected void hook377() throws DatabaseException {
     ...
     private void  hook381__wrappee__Evictor  () throws DatabaseException {
    }
    ...
    protected void hook381() throws DatabaseException {
      ...
      _this.nEvictPasses++;
      hook381__wrappee__Evictor();
    }

		
     private void  hook382__wrappee__Evictor  () throws DatabaseException {
    }

		
    protected void hook382() throws DatabaseException {
      _this.nNodesScanned+=_this.nNodesScannedThisRun;
      hook382__wrappee__Evictor();
    }
...
@MethodObject static  class  Evictor_isRunnable {
  ...
  protected long hook379(  IN parent,  int index,  INList inlist,  ScanIterator scanIter,  boolean envIsReadOnly,  long evictBytes,  IN renewedChild) throws DatabaseException {
   ...
   private void  hook380__wrappee__Evictor  (  IN target) throws DatabaseException {
  }
  ...
  protected void hook380(  IN target) throws DatabaseException {
    ...
    hook380__wrappee__Evictor(target);
  }

	
   private void  hook383__wrappee__Evictor  (  long evictedBytes) throws DatabaseException {
  }
  ...
  protected void hook383(  long evictedBytes) throws DatabaseException {
    ...
    hook383__wrappee__Evictor(evictedBytes);
  }

	
   private void  hook384__wrappee__Evictor  () throws DatabaseException {
  }
