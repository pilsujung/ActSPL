...
public class PersistentJournal_ESTest2 extends PersistentJournal_ESTest_scaffolding2 {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          PrevaylerDirectory prevaylerDirectory0 = new PrevaylerDirectory("-PzUF42");
          PersistentJournal persistentJournal0 = null;
          try {
            persistentJournal0 = new PersistentJournal(prevaylerDirectory0, (-900L), (-3418L), "journal");
            fail("Expecting exception: SecurityException");
          
          } catch(SecurityException e) {
             //
             // Security manager blocks (\"java.io.FilePermission\" \"-PzUF42\" \"write\")
             ...
             // sun.reflect.GeneratedConstructorAccessor37.newInstance(Unknown Source)
  ...
  public void test1()  throws Throwable  {
      ...
      PersistentJournal persistentJournal0 = null;
      try {
        persistentJournal0 = new PersistentJournal(prevaylerDirectory0, 0L, 2906L, (String) null, (Monitor) log4jMonitor0);
  ...
  public void test2()  throws Throwable  {
      ...
      PersistentJournal persistentJournal0 = null;
      try {
        persistentJournal0 = new PersistentJournal(prevaylerDirectory0, 858L, 858L, (String) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test3()  throws Throwable  {
      PrevaylerDirectory prevaylerDirectory0 = new PrevaylerDirectory("j+");
      PersistentJournal persistentJournal0 = null;
      try {
        persistentJournal0 = new PersistentJournal(prevaylerDirectory0, 0L, 0L, "lN");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Journal filename suffix must match /[a-zA-Z0-9]*[Jj]ournal/, but 'lN' does not
         //
         assertThrownBy("org.prevayler.implementation.PrevaylerDirectory", e);
      }
  }
  ...
  public void test4()  throws Throwable  {
      ...
      PersistentJournal persistentJournal0 = null;
      try {
        persistentJournal0 = new PersistentJournal(prevaylerDirectory0, 0L, 0L, "", (Monitor) simpleMonitor0);
        fail("Expecting exception: IllegalArgumentException");
