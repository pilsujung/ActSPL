...
public class DbPrintLog_ESTest4 extends DbPrintLog_ESTest_scaffolding4 {
  ...
  public void test7()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          stringArray0[0] = "-h";
          stringArray0[1] = "# The lock timeout for cleaner transactions in microseconds.\n# The default is set to 0.5 seconds.";
          // Undeclared exception!
          try { 
            DbPrintLog.main(stringArray0);
            fail("Expecting exception: SecurityException");
