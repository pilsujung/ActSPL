...
public class ChildReference_ESTest7 extends ChildReference_ESTest_scaffolding7 {
  ...
  public void test08()  throws Throwable  {
      ...
      ChildReference childReference0 = new ChildReference();
      DIN dIN0 = new DIN(databaseImpl0, byteArray0, 1224, byteArray0, childReference0, 1224);
      ChildReference childReference1 = new ChildReference((Node) dIN0, byteArray0, 649L);
      DIN dIN1 = (DIN)childReference1.fetchTarget(databaseImpl0, dIN0);
      //  // Unstable assertion: assertEquals(214L, dIN1.getLastId());
  }
  ...
  public void test27()  throws Throwable  {
      ChildReference childReference0 = new ChildReference();
      byte[] byteArray0 = childReference0.getKey();
      childReference0.setLsn((-1382L));
      DatabaseImpl databaseImpl0 = new DatabaseImpl();
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, 1224, (-4764));
      try { 
        childReference0.fetchTarget(databaseImpl0, bIN0);
        fail("Expecting exception: DatabaseException");
      
      } catch(DatabaseException e) {
         //
         // fetchTarget of 0xffffffff/0xfffffa9a IN=308 state=2 java.lang.NullPointerException
         //
         assertThrownBy("com.sleepycat.je.tree.ChildReference", e);
      }
  }
  ...
  public void test28()  throws Throwable  {
      ...
      IN iN0 = new IN();
      ChildReference childReference0 = new ChildReference((Node) iN0, byteArray0, (long) 0);
      DIN dIN0 = new DIN(databaseImpl0, byteArray0, (int) (byte)0, byteArray0, childReference0, 24);
      childReference0.fetchTarget(databaseImpl0, dIN0);
      //  // Unstable assertion: assertEquals(140L, dIN0.getNodeId());
