...
public class RootFlusher_ESTest7 extends RootFlusher_ESTest_scaffolding7 {
  ...
  public void test0()  throws Throwable  {
      ...
      RootFlusher rootFlusher0 = new RootFlusher(databaseImpl0, (LogManager) null, 2931L);
      byte[] byteArray0 = new byte[4];
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, (int) (byte)0, (int) (byte)0);
      ChildReference childReference0 = new ChildReference((Node) bIN0, byteArray0, (long) 1000);
      rootFlusher0.doWork(childReference0);
      //  // Unstable assertion: assertEquals(46L, bIN0.getNodeId());
      //  // Unstable assertion: assertEquals(45L, databaseImpl0.getEofNodeId());
  }
