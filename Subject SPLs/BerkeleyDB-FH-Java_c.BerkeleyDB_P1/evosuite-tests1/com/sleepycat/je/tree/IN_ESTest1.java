...
public class IN_ESTest1 extends IN_ESTest_scaffolding1 {
  ...
  public void test010()  throws Throwable  {
      ...
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, (int) (byte)0, 0);
      // Undeclared exception!
      try { 
  ...
  public void test034()  throws Throwable  {
      DatabaseImpl databaseImpl0 = new DatabaseImpl();
      byte[] byteArray0 = new byte[0];
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, 4866, (-2193));
      // Undeclared exception!
      try { 
        bIN0.initEntryLsn((-3395));
  ...
  public void test072()  throws Throwable  {
      byte[] byteArray0 = new byte[6];
      DatabaseImpl databaseImpl0 = new DatabaseImpl();
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, (int) (byte)10, Integer.MAX_VALUE);
  ...
  public void test073()  throws Throwable  {
      DIN dIN0 = new DIN();
      IN.IN_splitInternal iN_IN_splitInternal0 = new IN.IN_splitInternal(dIN0, dIN0, 14, 14, 6);
      iN_IN_splitInternal0.low = 1;
      // Undeclared exception!
      try { 
  ...
  public void test075()  throws Throwable  {
      DBIN dBIN0 = new DBIN();
      byte[] byteArray0 = new byte[0];
      IN.IN_setEntry iN_IN_setEntry0 = new IN.IN_setEntry(dBIN0, (-65537), dBIN0, byteArray0, 14, (byte)46);
      // Undeclared exception!
      try { 
  ...
  public void test081()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, 4866, (-2193));
      bIN0.findEntry(byteArray0, true, true);
  }
  ...
  public void test091()  throws Throwable  {
      DBIN dBIN0 = new DBIN();
      byte[] byteArray0 = new byte[5];
      IN.IN_updateEntry3 iN_IN_updateEntry3_0 = new IN.IN_updateEntry3(dBIN0, 14, dBIN0, 0L, byteArray0);
  ...
  public void test093()  throws Throwable  {
      byte[] byteArray0 = new byte[3];
      ChildReference childReference0 = new ChildReference((Node) null, byteArray0, 127L, (byte)54);
  ...
  public void test094()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, 4866, (-2193));
      IN.IN_updateEntry2 iN_IN_updateEntry2_0 = new IN.IN_updateEntry2(bIN0, 2336, bIN0, 4866);
  ...
  public void test096()  throws Throwable  {
      DBIN dBIN0 = new DBIN();
      byte[] byteArray0 = new byte[9];
      IN.IN_updateEntryCompareKey iN_IN_updateEntryCompareKey0 = new IN.IN_updateEntryCompareKey(dBIN0, 14, dBIN0, 14, byteArray0);
  ...
  public void test097()  throws Throwable  {
      BIN bIN0 = new BIN();
      byte[] byteArray0 = new byte[8];
      IN.IN_setEntry iN_IN_setEntry0 = new IN.IN_setEntry(bIN0, 1721, bIN0, byteArray0, (byte) (-2), (byte)81);
  ...
  public void test098()  throws Throwable  {
      BIN bIN0 = new BIN();
      IN.IN_splitInternal iN_IN_splitInternal0 = new IN.IN_splitInternal(bIN0, bIN0, 65537, (byte) (-35), 0);
  ...
  public void test100()  throws Throwable  {
      DBIN dBIN0 = new DBIN();
      IN.IN_splitInternal iN_IN_splitInternal0 = new IN.IN_splitInternal(dBIN0, dBIN0, 3244, 14, (-4778));
  ...
  public void test114()  throws Throwable  {
      IN iN0 = new IN();
      byte[] byteArray0 = new byte[0];
      ChildReference childReference0 = new ChildReference((Node) iN0, byteArray0, 5468610455715211324L);
      IN.IN_insertEntry1 iN_IN_insertEntry1_0 = new IN.IN_insertEntry1(iN0, childReference0);
      DatabaseImpl databaseImpl0 = new DatabaseImpl();
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, 14, (int) (byte)1);
      iN_IN_insertEntry1_0._this = (IN) bIN0;
      iN_IN_insertEntry1_0.execute();
      //  // Unstable assertion: assertEquals(1558L, iN0.getLastId());
  }
  ...
  public void test118()  throws Throwable  {
      ...
      DIN dIN0 = new DIN(databaseImpl0, byteArray0, 2954, byteArray0, childReference0, 2954);
      // Undeclared exception!
      try { 
        dIN0.postFetchInit(databaseImpl0, (-1L));
        fail("Expecting exception: NullPointerException");
  ...
  public void test120()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, 4866, (-2193));
      bIN0.setGeneration((-1L));
      //  // Unstable assertion: assertEquals(1238L, bIN0.getLastId());
  }
  ...
  public void test124()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        dIN0.setEntry(0, dupCountLN0, byteArray0, (byte)15, (byte)3);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test127()  throws Throwable  {
      DatabaseImpl databaseImpl0 = new DatabaseImpl();
      byte[] byteArray0 = new byte[7];
      IN iN0 = new IN(databaseImpl0, byteArray0, 2679, (-44));
      iN0.toString();
      //  // Unstable assertion: assertEquals(1056L, iN0.getNodeId());
  }
  ...
  public void test136()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[0];
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, 4866, (-2193));
      bIN0.getEntryLsnByteArray();
      //  // Unstable assertion: assertEquals(893L, databaseImpl0.getEofNodeId());
  }
  ...
  public void test137()  throws Throwable  {
      DatabaseImpl databaseImpl0 = new DatabaseImpl();
      byte[] byteArray0 = new byte[7];
      BIN bIN0 = new BIN(databaseImpl0, byteArray0, 0, (int) (byte)7);
      bIN0.getDatabaseId();
      //  // Unstable assertion: assertEquals(729L, databaseImpl0.getEofNodeId());
  }
  ...
  public void test139()  throws Throwable  {
      ...
      byte[] byteArray0 = new byte[7];
      IN iN0 = new IN(databaseImpl0, byteArray0, 2679, (-44));
      iN0.createNewInstance(byteArray0, (byte)62, (byte) (-109));
      //  // Unstable assertion: assertEquals(458L, databaseImpl0.getEofNodeId());
  }
  ...
  public void test146()  throws Throwable  {
      DatabaseImpl databaseImpl0 = new DatabaseImpl();
      byte[] byteArray0 = new byte[3];
      IN iN0 = new IN(databaseImpl0, byteArray0, 0, (int) (byte) (-96));
      DBIN dBIN0 = new DBIN();
      // Undeclared exception!
      try { 
        iN0.split(dBIN0, 14, 0);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
  ...
  public void test152()  throws Throwable  {
      IN iN0 = new IN();
      SearchResult searchResult0 = new SearchResult();
      iN0.descendOnParentSearch(searchResult0, true, true, (-1), iN0, false);
      assertFalse(iN0.getDirty());
      assertEquals((-1L), iN0.getLastFullVersion());
      assertEquals(0, iN0.getLevel());
      assertEquals(0, iN0.getNEntries());
  ...
  public void test153()  throws Throwable  {
      DBIN dBIN0 = new DBIN();
      DatabaseImpl databaseImpl0 = new DatabaseImpl();
      dBIN0.postRecoveryInit(databaseImpl0, (-917L));
      assertEquals((-917L), dBIN0.getLastFullVersion());
  }
  ...
  public void test167()  throws Throwable  {
      DIN dIN0 = new DIN();
      IN.IN_deleteEntry iN_IN_deleteEntry0 = new IN.IN_deleteEntry(dIN0, 339, true);
