...
public static void exitEvoSuiteFramework() {
  ...
  public void test0()  throws Throwable  {
      Note note0 = new Note("hZ1$pZ]z[]", (-123));
      assertEquals((-123), note0.note);
  }
   ...
   * Goal 37. Weak Mutation 33: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceVariable leng -> i
   * Goal 38. Weak Mutation 34: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp Negation of leng
   * Goal 39. Weak Mutation 35: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp IINC 1 leng
   * Goal 40. Weak Mutation 36: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp IINC -1 leng
   * Goal 41. Weak Mutation 38: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceArithmeticOperator - -> %
   * Goal 42. Weak Mutation 40: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceArithmeticOperator - -> /
   * Goal 43. Weak Mutation 42: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceComparisonOperator < -> -2
   * Goal 44. Weak Mutation 43: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceComparisonOperator < -> <=
   * Goal 45. Weak Mutation 18: Note.<init>(Ljava/lang/String;I)V:16 - ReplaceVariable name -> name
   * Goal 46. Weak Mutation 19: Note.<init>(Ljava/lang/String;I)V:16 - ReplaceConstant -   -> 
   * Goal 47. Weak Mutation 44: Note.<init>(Ljava/lang/String;I)V:18 - ReplaceVariable name -> name
   * Goal 48. Weak Mutation 45: Note.<init>(Ljava/lang/String;I)V:20 - ReplaceVariable note -> note
   * Goal 49. Weak Mutation 46: Note.<init>(Ljava/lang/String;I)V:20 - InsertUnaryOp Negation of note
   * Goal 50. Weak Mutation 47: Note.<init>(Ljava/lang/String;I)V:20 - InsertUnaryOp IINC 1 note
   * Goal 51. Weak Mutation 48: Note.<init>(Ljava/lang/String;I)V:20 - InsertUnaryOp IINC -1 note
   */

  @Test(timeout = 4000)
  public void test2()  throws Throwable  {
      Note note0 = new Note("", (-123));
      assertEquals((-123), note0.note);
  }
  ...
  public void test3()  throws Throwable  {
      Note note0 = new Note("k(/ZZbu", (-5347));
      assertEquals((-5347), note0.note);
  }
   ...
   * 44 covered goals:
   * Goal 1. Note.<init>(Ljava/lang/String;I)V: I9 Branch 1 IF_ICMPLT L11 - true
   * Goal 2. Note.<init>(Ljava/lang/String;I)V: I51 Branch 2 IF_ICMPLT L15 - false
   * Goal 3. Branch Note.<init>(Ljava/lang/String;I)V: I9 Branch 1 IF_ICMPLT L11 - true in context: Note:<init>(Ljava/lang/String;I)V
   * Goal 4. Branch Note.<init>(Ljava/lang/String;I)V: I51 Branch 2 IF_ICMPLT L15 - false in context: Note:<init>(Ljava/lang/String;I)V
   * Goal 5. Note.<init>(Ljava/lang/String;I)V: Line 11
   * Goal 6. Note.<init>(Ljava/lang/String;I)V: Line 14
   * Goal 7. Note.<init>(Ljava/lang/String;I)V: Line 15
   * Goal 8. Note.<init>(Ljava/lang/String;I)V: Line 18
   * Goal 9. Note.<init>(Ljava/lang/String;I)V: Line 20
   * Goal 10. Note.<init>(Ljava/lang/String;I)V: Line 21
   * Goal 11. [METHOD] Note.<init>(Ljava/lang/String;I)V
   * Goal 12. [METHODNOEX] Note.<init>(Ljava/lang/String;I)V
   * Goal 13. Weak Mutation 0: Note.<init>(Ljava/lang/String;I)V:11 - ReplaceVariable name -> name
   * Goal 14. Weak Mutation 1: Note.<init>(Ljava/lang/String;I)V:11 - ReplaceConstant - 7 -> 0
   * Goal 15. Weak Mutation 2: Note.<init>(Ljava/lang/String;I)V:11 - ReplaceConstant - 7 -> 1
   * Goal 16. Weak Mutation 3: Note.<init>(Ljava/lang/String;I)V:11 - ReplaceConstant - 7 -> -1
   * Goal 17. Weak Mutation 4: Note.<init>(Ljava/lang/String;I)V:11 - ReplaceConstant - 7 -> 6
   * Goal 18. Weak Mutation 5: Note.<init>(Ljava/lang/String;I)V:11 - ReplaceConstant - 7 -> 8
   * Goal 19. Weak Mutation 7: Note.<init>(Ljava/lang/String;I)V:11 - ReplaceComparisonOperator < -> -2
   * Goal 20. Weak Mutation 16: Note.<init>(Ljava/lang/String;I)V:14 - ReplaceVariable name -> name
   * Goal 21. Weak Mutation 17: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceConstant - 0 -> 1
   * Goal 22. Weak Mutation 22: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceVariable i -> leng
   * Goal 23. Weak Mutation 24: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp Negation of i
   * Goal 24. Weak Mutation 25: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp IINC 1 i
   * Goal 25. Weak Mutation 26: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp IINC -1 i
   * Goal 26. Weak Mutation 27: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceConstant - 6 -> 0
   * Goal 27. Weak Mutation 28: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceConstant - 6 -> 1
   * Goal 28. Weak Mutation 29: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceConstant - 6 -> -1
   * Goal 29. Weak Mutation 30: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceConstant - 6 -> 5
   * Goal 30. Weak Mutation 31: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceConstant - 6 -> 7
   * Goal 31. Weak Mutation 32: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceVariable leng -> note
   * Goal 32. Weak Mutation 33: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceVariable leng -> i
   * Goal 33. Weak Mutation 34: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp Negation of leng
   * Goal 34. Weak Mutation 35: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp IINC 1 leng
   * Goal 35. Weak Mutation 36: Note.<init>(Ljava/lang/String;I)V:15 - InsertUnaryOp IINC -1 leng
   * Goal 36. Weak Mutation 37: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceArithmeticOperator - -> +
   * Goal 37. Weak Mutation 39: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceArithmeticOperator - -> *
   * Goal 38. Weak Mutation 40: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceArithmeticOperator - -> /
   * Goal 39. Weak Mutation 43: Note.<init>(Ljava/lang/String;I)V:15 - ReplaceComparisonOperator < -> <=
   * Goal 40. Weak Mutation 44: Note.<init>(Ljava/lang/String;I)V:18 - ReplaceVariable name -> name
   * Goal 41. Weak Mutation 45: Note.<init>(Ljava/lang/String;I)V:20 - ReplaceVariable note -> note
   * Goal 42. Weak Mutation 46: Note.<init>(Ljava/lang/String;I)V:20 - InsertUnaryOp Negation of note
   * Goal 43. Weak Mutation 47: Note.<init>(Ljava/lang/String;I)V:20 - InsertUnaryOp IINC 1 note
   * Goal 44. Weak Mutation 48: Note.<init>(Ljava/lang/String;I)V:20 - InsertUnaryOp IINC -1 note
   */

  @Test(timeout = 4000)
  public void test4()  throws Throwable  {
      Note note0 = new Note("hZ1$pZ", (-123));
      assertEquals((-123), note0.note);
  }
}
