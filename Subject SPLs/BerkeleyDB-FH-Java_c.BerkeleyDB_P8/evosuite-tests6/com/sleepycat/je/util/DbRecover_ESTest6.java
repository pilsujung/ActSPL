...
public class DbRecover_ESTest6 extends DbRecover_ESTest_scaffolding6 {
  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
          ...
          stringArray0[0] = "-h";
          stringArray0[1] = "# If non-0 (default is 0) break all IO into chunks of this size.\n# This setting is only used if je.log.useNIO=true.";
