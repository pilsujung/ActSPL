 ...
 */
  ...
  public int invokeCleaner() throws DatabaseException {
   ...
   private void  requestShutdownDaemons__wrappee__base  (){
    closing=true;
    this.hook331();
    this.hook334();
    this.hook327();
  ...
  private void requestShutdownDaemons(){
    requestShutdownDaemons__wrappee__base();
    if (cleaner != null) {
 ...
 * Ask all daemon threads to shut down.
 */
   private void  shutdownDaemons__wrappee__CleanerDaemon  () throws InterruptedException {
    shutdownCleaner();
 ...
 */
  private void shutdownDaemons() throws InterruptedException {
    ...
    shutdownDaemons__wrappee__CleanerDaemon();
  }
...
@MethodObject static  class  EnvironmentImpl_createDaemons {
  ...
  protected void hook331(){
   ...
   private void  hook333__wrappee__base  (  DbConfigManager mgr) throws DatabaseException {
  }
