...
throw new ReturnObject(_this.fetchCurrent(foundKey,foundData,lockType,first));
 ...
 private void  hook204__wrappee__base  (LN ln,long oldLsn,long newLsn) throws DatabaseException {
}
  ...
  protected void hook204(  LN ln,  long oldLsn,  long newLsn) throws DatabaseException {
    ...
    hook204__wrappee__base(ln,oldLsn,newLsn);
  }

	
 private void  hook205__wrappee__base  (LN ln,long oldLsn,long newLsn) throws DatabaseException {
}
  ...
  protected void hook205(  LN ln,  long oldLsn,  long newLsn) throws DatabaseException {
    ...
    hook205__wrappee__base(ln,oldLsn,newLsn);
  }
