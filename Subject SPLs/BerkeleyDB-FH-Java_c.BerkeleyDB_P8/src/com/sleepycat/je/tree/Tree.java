 ...
 * constructor helper
 */
   private void  init__wrappee__base  (  DatabaseImpl database){
 ...
 */
   private void  setRoot__wrappee__base  (  ChildReference newRoot,  boolean notLatched){
    root=newRoot;
  }
 ...
 */
  public void setRoot(  ChildReference newRoot,  boolean notLatched){
    ...
    setRoot__wrappee__base(newRoot,notLatched);
  }
...
private   class  RootChildReference  extends ChildReference {
    ...
    public void setLsn(    long lsn){
     ...
     private void  hook666__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook666() throws DatabaseException {
      ...
      hook666__wrappee__base();
    }

		
     private void  hook667__wrappee__base  (){
    }

		
    protected void hook667(){
      assert rootLatch.isWriteLockedByCurrentThread();
      hook667__wrappee__base();
    }

		
     private void  hook668__wrappee__base  (){
    }
    ...
    protected void hook668(){
     ...
     private void  hook669__wrappee__base  (){
    }
 ...
 * any removal.
 */
   private IN  logTreeRemoval__wrappee__base  (  IN rootIN,  UtilizationTracker tracker) throws DatabaseException {
 ...
 */
  private IN logTreeRemoval(  IN rootIN,  UtilizationTracker tracker) throws DatabaseException {
    assert rootLatch.isWriteLockedByCurrentThread();
    return logTreeRemoval__wrappee__base(rootIN,tracker);
  }
...
@MethodObject static  class  Tree_searchSplitsAllowed {
    ...
    protected EnvironmentImpl env;
     ...
     private void  hook716__wrappee__base  () throws DatabaseException {
      while (true) {
        if (_this.root != null) {
    ...
    protected void hook716() throws DatabaseException {
     ...
     private void  hook717__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook717() throws DatabaseException {
      ...
      hook717__wrappee__base();
    }

		
     private void  hook718__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook718() throws DatabaseException {
      rootIN.latch();
      hook718__wrappee__base();
    }

		
     private void  hook719__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook719() throws DatabaseException {
      ...
      hook719__wrappee__base();
    }

		
     private void  hook720__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook720() throws DatabaseException {
      ...
      _this.rootLatch.release();
      rootLatched=false;
      hook720__wrappee__base();
    }

		
     private void  hook721__wrappee__base  () throws DatabaseException {
    }
      ...
      allRightSideDescent=true;
{
 ...
 while (!(parent instanceof BIN));
    ...
    protected SplitInfo info2;
     ...
     private void  hook722__wrappee__base  () throws DatabaseException, SplitRequiredException {
    }

		
    protected void hook722() throws DatabaseException, SplitRequiredException {
      isRootLatched=false;
      hook722__wrappee__base();
    }

		
     private void  hook723__wrappee__base  () throws DatabaseException, SplitRequiredException {
    }
    ...
    protected void hook723() throws DatabaseException, SplitRequiredException {
     ...
     private void  hook724__wrappee__base  () throws DatabaseException, SplitRequiredException {
    }
    ...
    protected void hook724() throws DatabaseException, SplitRequiredException {
     ...
     private void  hook725__wrappee__base  () throws DatabaseException, SplitRequiredException {
    }
    ...
    protected void hook725() throws DatabaseException, SplitRequiredException {
     ...
     private void  hook726__wrappee__base  () throws DatabaseException, SplitRequiredException {
    }
    ...
    protected void hook726() throws DatabaseException, SplitRequiredException {
     ...
     private void  hook727__wrappee__base  () throws DatabaseException, SplitRequiredException {
    }
   ...
   private void  hook657__wrappee__base  (  LN ln,  EnvironmentImpl env,  BIN bin,  int index,  long newLsn) throws DatabaseException {
  }
  ...
  protected void hook657(  LN ln,  EnvironmentImpl env,  BIN bin,  int index,  long newLsn) throws DatabaseException {
    ...
    hook657__wrappee__base(ln,env,bin,index,newLsn);
  }

	
   private void  hook658__wrappee__base  (  LN ln,  EnvironmentImpl env,  BIN bin,  int index,  long newLsn) throws DatabaseException {
  }

	
  protected void hook658(  LN ln,  EnvironmentImpl env,  BIN bin,  int index,  long newLsn) throws DatabaseException {
    traceInsert(Level.FINER,env,bin,ln,newLsn,index);
    hook658__wrappee__base(ln,env,bin,index,newLsn);
  }

	
   private void  hook659__wrappee__base  (  LN newLN,  long binNid,  DBIN dupBin,  long newLsn) throws DatabaseException {
  }
  ...
  protected void hook659(  LN newLN,  long binNid,  DBIN dupBin,  long newLsn) throws DatabaseException {
    ...
    hook659__wrappee__base(newLN,binNid,dupBin,newLsn);
  }

	
   private void  hook660__wrappee__base  (  LN newLN,  long binNid,  DBIN dupBin,  long newLsn) throws DatabaseException {
  }

	
  protected void hook660(  LN newLN,  long binNid,  DBIN dupBin,  long newLsn) throws DatabaseException {
    traceInsertDuplicate(Level.FINER,database.getDbEnvironment(),dupBin,newLN,newLsn,binNid);
    hook660__wrappee__base(newLN,binNid,dupBin,newLsn);
  }
  ...
  protected void hook665(  IN subtreeRoot) throws DatabaseException {
   ...
   private void  hook670__wrappee__base  (  WithRootLatched wrl) throws DatabaseException {
    this.hook728();
  ...
  protected void hook670(  WithRootLatched wrl) throws DatabaseException {
   ...
   private void  hook671__wrappee__base  (  WithRootLatched wrl) throws DatabaseException {
    this.hook729();
    throw new ReturnObject(wrl.doWork(root));
  }
  ...
  protected void hook671(  WithRootLatched wrl) throws DatabaseException {
   ...
   private void  hook672__wrappee__base  (  byte[] idKey,  UtilizationTracker tracker,  IN subtreeRootIN,  ArrayList nodeLadder,  IN rootIN,  boolean rootNeedsUpdating) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    if (root == null) {
  ...
  protected void hook672(  byte[] idKey,  UtilizationTracker tracker,  IN subtreeRootIN,  ArrayList nodeLadder,  IN rootIN,  boolean rootNeedsUpdating) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    rootLatch.acquireExclusive();
    try {
      hook672__wrappee__base(idKey,tracker,subtreeRootIN,nodeLadder,rootIN,rootNeedsUpdating);
    }
  finally {
   ...
   private void  hook673__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook673() throws DatabaseException {
    assert rootLatch.isWriteLockedByCurrentThread();
    hook673__wrappee__base();
  }

	
   private IN  hook674__wrappee__base  (  byte[] idKey,  byte[] mainKey,  IN in,  IN deletedSubtreeRoot) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    this.hook730(in);
  ...
  protected IN hook674(  byte[] idKey,  byte[] mainKey,  IN in,  IN deletedSubtreeRoot) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    try {
      deletedSubtreeRoot=hook674__wrappee__base(idKey,mainKey,in,deletedSubtreeRoot);
    }
  finally {
      in.releaseLatch();
    }
   ...
   private void  hook675__wrappee__base  (  DIN duplicateRoot) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }
  ...
  protected void hook675(  DIN duplicateRoot) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    ...
    hook675__wrappee__base(duplicateRoot);
  }

	
   private void  hook676__wrappee__base  (  ArrayList nodeLadder) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }

	
  protected void hook676(  ArrayList nodeLadder) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    releaseNodeLadderLatches(nodeLadder);
    hook676__wrappee__base(nodeLadder);
  }

	
   private void  hook677__wrappee__base  (  DIN dupRoot) throws DatabaseException {
  }

	
  protected void hook677(  DIN dupRoot) throws DatabaseException {
    assert dupRoot.isLatchOwner();
    hook677__wrappee__base(dupRoot);
  }

	
   private void  hook678__wrappee__base  (  DIN dupRoot) throws DatabaseException {
  }

	
  protected void hook678(  DIN dupRoot) throws DatabaseException {
    assert dupRoot.isLatchOwner();
    hook678__wrappee__base(dupRoot);
  }

	
   private void  hook679__wrappee__base  (  IN child) throws DatabaseException {
  }

	
  protected void hook679(  IN child) throws DatabaseException {
    child.releaseLatch();
    hook679__wrappee__base(child);
  }

	
   private void  hook680__wrappee__base  (  IN child) throws DatabaseException {
  }

	
  protected void hook680(  IN child) throws DatabaseException {
    assert child.isLatchOwner();
    hook680__wrappee__base(child);
  }

	
   private void  hook681__wrappee__base  (  IN potentialParent) throws DatabaseException {
  }

	
  protected void hook681(  IN potentialParent) throws DatabaseException {
    potentialParent.releaseLatchIfOwner();
    hook681__wrappee__base(potentialParent);
  }

	
   private void  hook682__wrappee__base  (  IN searchResult) throws DatabaseException {
  }

	
  protected void hook682(  IN searchResult) throws DatabaseException {
    searchResult.releaseLatchIfOwner();
    hook682__wrappee__base(searchResult);
  }

	
   private void  hook683__wrappee__base  (  TreeLocation location,  byte[] mainKey,  byte[] dupKey,  LN ln,  boolean splitsAllowed,  boolean findDeletedEntries,  boolean searchDupTree,  boolean updateGeneration,  boolean exactSearch,  boolean indicateIfExact,  Node childNode) throws DatabaseException {
    if (childNode == null) {
    }
  ...
  protected void hook683(  TreeLocation location,  byte[] mainKey,  byte[] dupKey,  LN ln,  boolean splitsAllowed,  boolean findDeletedEntries,  boolean searchDupTree,  boolean updateGeneration,  boolean exactSearch,  boolean indicateIfExact,  Node childNode) throws DatabaseException {
    try {
      hook683__wrappee__base(location,mainKey,dupKey,ln,splitsAllowed,findDeletedEntries,searchDupTree,updateGeneration,exactSearch,indicateIfExact,childNode);
    }
   ...
   private void  hook684__wrappee__base  (  BIN oldBIN) throws DatabaseException {
  }
  ...
  protected void hook684(  BIN oldBIN) throws DatabaseException {
    ...
    hook684__wrappee__base(oldBIN);
  }

	
   private void  hook685__wrappee__base  (  TreeLocation location,  byte[] dupKey,  DIN dupRoot,  LN ln,  boolean findDeletedEntries,  boolean indicateIfExact,  boolean exactSearch,  boolean splitsAllowed,  boolean updateGeneration) throws DatabaseException {
  ...
  protected void hook685(  TreeLocation location,  byte[] dupKey,  DIN dupRoot,  LN ln,  boolean findDeletedEntries,  boolean indicateIfExact,  boolean exactSearch,  boolean splitsAllowed,  boolean updateGeneration) throws DatabaseException {
    dupRoot.latch();
    try {
      hook685__wrappee__base(location,dupKey,dupRoot,ln,findDeletedEntries,indicateIfExact,exactSearch,splitsAllowed,updateGeneration);
    }
 catch (    DatabaseException e) {
   ...
   private void  hook686__wrappee__base  (  boolean traverseWithinDupTree,  boolean forward,  byte[] idKey,  IN next,  IN parent,  IN nextIN) throws DatabaseException {
    while (true) {
  ...
  protected void hook686(  boolean traverseWithinDupTree,  boolean forward,  byte[] idKey,  IN next,  IN parent,  IN nextIN) throws DatabaseException {
    try {
      hook686__wrappee__base(traverseWithinDupTree,forward,idKey,next,parent,nextIN);
    }
 catch (    DatabaseException e) {
   ...
   private void  hook687__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook687() throws DatabaseException {
    assert LatchSupport.countLatchesHeld() == 1 : LatchSupport.latchesHeldToString();
    hook687__wrappee__base();
  }

	
   private void  hook688__wrappee__base  (  LogManager logManager,  INList inMemoryINs,  IN curRoot,  long curRootLsn,  long logLsn,  IN newRoot) throws DatabaseException {
    byte[] rootIdKey=curRoot.getKey(0);
  ...
  protected void hook688(  LogManager logManager,  INList inMemoryINs,  IN curRoot,  long curRootLsn,  long logLsn,  IN newRoot) throws DatabaseException {
    try {
      hook688__wrappee__base(logManager,inMemoryINs,curRoot,curRootLsn,logLsn,newRoot);
    }
  finally {
   ...
   private void  hook689__wrappee__base  (  IN curRoot) throws DatabaseException {
  }

	
  protected void hook689(  IN curRoot) throws DatabaseException {
    curRoot.latch();
    hook689__wrappee__base(curRoot);
  }

	
   private void  hook690__wrappee__base  (  IN parent) throws DatabaseException {
  }

	
  protected void hook690(  IN parent) throws DatabaseException {
    assert parent.isLatchOwner();
    hook690__wrappee__base(parent);
  }

	
   private void  hook691__wrappee__base  (  IN parent) throws DatabaseException {
  }

	
  protected void hook691(  IN parent) throws DatabaseException {
    parent.releaseLatch();
    hook691__wrappee__base(parent);
  }

	
   private void  hook692__wrappee__base  (  IN parent) throws DatabaseException, Throwable {
  }

	
  protected void hook692(  IN parent) throws DatabaseException, Throwable {
    parent.releaseLatch();
    hook692__wrappee__base(parent);
  }

	
   private void  hook693__wrappee__base  (  IN child) throws DatabaseException, Throwable {
  }

	
  protected void hook693(  IN child) throws DatabaseException, Throwable {
    child.releaseLatch();
    hook693__wrappee__base(child);
  }

	
   private void  hook694__wrappee__base  (  IN parent,  IN child) throws DatabaseException {
  }
  ...
  protected void hook694(  IN parent,  IN child) throws DatabaseException {
    ...
    parent.releaseLatchIfOwner();
    hook694__wrappee__base(parent,child);
  }

	
   private void  hook695__wrappee__base  (  IN parent) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }

	
  protected void hook695(  IN parent) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    assert parent.isLatchOwner();
    hook695__wrappee__base(parent);
  }

	
   private void  hook696__wrappee__base  (  SplitInfo info5) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }
  ...
  protected void hook696(  SplitInfo info5) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    ...
    hook696__wrappee__base(info5);
  }

	
   private void  hook697__wrappee__base  (  ArrayList nodeLadder) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }

	
  protected void hook697(  ArrayList nodeLadder) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    releaseNodeLadderLatches(nodeLadder);
    hook697__wrappee__base(nodeLadder);
  }

	
   private void  hook698__wrappee__base  (  IN parent,  byte[] key,  long nid,  boolean updateGeneration,  int index,  IN child) throws DatabaseException, SplitRequiredException {
    do {
      if (parent.getNEntries() == 0) {
 ...
 while (!(parent instanceof BIN));
  ...
  protected void hook698(  IN parent,  byte[] key,  long nid,  boolean updateGeneration,  int index,  IN child) throws DatabaseException, SplitRequiredException {
    try {
      hook698__wrappee__base(parent,key,nid,updateGeneration,index,child);
    }
 catch (    DatabaseException e) {
      if (child != null) {
        child.releaseLatchIfOwner();
   ...
   private void  hook699__wrappee__base  (  IN parent) throws DatabaseException, SplitRequiredException {
  }

	
  protected void hook699(  IN parent) throws DatabaseException, SplitRequiredException {
    assert parent.isLatchOwner();
    hook699__wrappee__base(parent);
  }

	
   private void  hook700__wrappee__base  (  IN parent) throws DatabaseException, SplitRequiredException {
  }

	
  protected void hook700(  IN parent) throws DatabaseException, SplitRequiredException {
    parent.releaseLatch();
    hook700__wrappee__base(parent);
  }

	
   private void  hook701__wrappee__base  (  boolean updateGeneration,  IN rootIN) throws DatabaseException {
    if (root != null) {
      rootIN=(IN)root.fetchTarget(database,null);
  ...
  protected void hook701(  boolean updateGeneration,  IN rootIN) throws DatabaseException {
    try {
      hook701__wrappee__base(updateGeneration,rootIN);
    }
  finally {
      rootLatch.release();
    }
   ...
   private void  hook702__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook702() throws DatabaseException {
    rootLatch.acquireShared();
    hook702__wrappee__base();
  }

	
   private void  hook703__wrappee__base  (  LN ln,  byte[] key,  boolean allowDuplicates,  CursorImpl cursor,  LockResult lnLock,  EnvironmentImpl env,  LogManager logManager,  INList inMemoryINs,  BIN bin) throws DatabaseException {
  ...
  protected void hook703(  LN ln,  byte[] key,  boolean allowDuplicates,  CursorImpl cursor,  LockResult lnLock,  EnvironmentImpl env,  LogManager logManager,  INList inMemoryINs,  BIN bin) throws DatabaseException {
    try {
      hook703__wrappee__base(ln,key,allowDuplicates,cursor,lnLock,env,logManager,inMemoryINs,bin);
    }
  finally {
      cursor.releaseBIN();
    }
   ...
   private void  hook704__wrappee__base  (  byte[] key,  BIN bin,  LN newLN,  CursorImpl cursor,  LockResult lnLock,  boolean allowDuplicates,  EnvironmentImpl env,  int index,  boolean successfulInsert,  DIN dupRoot,  Node n,  long binNid,  DBIN dupBin) throws DatabaseException {
    dupRoot=(DIN)n;
  ...
  protected void hook704(  byte[] key,  BIN bin,  LN newLN,  CursorImpl cursor,  LockResult lnLock,  boolean allowDuplicates,  EnvironmentImpl env,  int index,  boolean successfulInsert,  DIN dupRoot,  Node n,  long binNid,  DBIN dupBin) throws DatabaseException {
    try {
      hook704__wrappee__base(key,bin,newLN,cursor,lnLock,allowDuplicates,env,index,successfulInsert,dupRoot,n,binNid,dupBin);
    }
  finally {
      if (dupBin != null) {
   ...
   private void  hook705__wrappee__base  (  DIN dupRoot) throws DatabaseException {
  }

	
  protected void hook705(  DIN dupRoot) throws DatabaseException {
    dupRoot.releaseLatch();
    hook705__wrappee__base(dupRoot);
  }

	
   private void  hook706__wrappee__base  (  BIN bin,  int index,  DIN curRoot,  LogManager logManager,  INList inMemoryINs,  byte[] rootIdKey,  DIN newRoot,  long curRootLsn,  long logLsn) throws DatabaseException {
    newRoot.setIsRoot(true);
  ...
  protected void hook706(  BIN bin,  int index,  DIN curRoot,  LogManager logManager,  INList inMemoryINs,  byte[] rootIdKey,  DIN newRoot,  long curRootLsn,  long logLsn) throws DatabaseException {
    try {
      hook706__wrappee__base(bin,index,curRoot,logManager,inMemoryINs,rootIdKey,newRoot,curRootLsn,logLsn);
    }
  finally {
      curRoot.releaseLatch();
    }
   ...
   private void  hook707__wrappee__base  (  DIN newRoot) throws DatabaseException {
  }

	
  protected void hook707(  DIN newRoot) throws DatabaseException {
    newRoot.latch();
    hook707__wrappee__base(newRoot);
  }

	
   private void  hook708__wrappee__base  (  byte[] key,  LogManager logManager,  INList inMemoryINs,  LN newLN,  CursorImpl cursor,  EnvironmentImpl env,  DIN dupRoot,  DBIN dupBin,  BIN bin,  int index,  LN existingLN,  byte[] newLNKey,  Locker locker,  DupCountLN dupCountLN,  long firstDupCountLNLsn) throws DatabaseException {
  ...
  protected void hook708(  byte[] key,  LogManager logManager,  INList inMemoryINs,  LN newLN,  CursorImpl cursor,  EnvironmentImpl env,  DIN dupRoot,  DBIN dupBin,  BIN bin,  int index,  LN existingLN,  byte[] newLNKey,  Locker locker,  DupCountLN dupCountLN,  long firstDupCountLNLsn) throws DatabaseException {
    try {
      hook708__wrappee__base(key,logManager,inMemoryINs,newLN,cursor,env,dupRoot,dupBin,bin,index,existingLN,newLNKey,locker,dupCountLN,firstDupCountLNLsn);
    }
 catch (    DatabaseException e) {
      dupBin.releaseLatchIfOwner();
      dupRoot.releaseLatchIfOwner();
   ...
   private void  hook709__wrappee__base  (  DBIN dupBin) throws DatabaseException {
  }

	
  protected void hook709(  DBIN dupBin) throws DatabaseException {
    dupBin.latch();
    hook709__wrappee__base(dupBin);
  }

	
   private void  hook710__wrappee__base  (  DIN dupRoot) throws DatabaseException {
  }

	
  protected void hook710(  DIN dupRoot) throws DatabaseException {
    dupRoot.latch();
    hook710__wrappee__base(dupRoot);
  }

	
   private BIN  hook711__wrappee__base  (  byte[] key,  LogManager logManager,  INList inMemoryINs,  BIN bin,  boolean rootLatchIsHeld) throws DatabaseException {
    long logLsn;
    while (true) {
  ...
  protected BIN hook711(  byte[] key,  LogManager logManager,  INList inMemoryINs,  BIN bin,  boolean rootLatchIsHeld) throws DatabaseException {
    try {
      bin=hook711__wrappee__base(key,logManager,inMemoryINs,bin,rootLatchIsHeld);
    }
  finally {
      if (rootLatchIsHeld) {
        rootLatch.release();
   ...
   private void  hook712__wrappee__base  (  BIN bin) throws DatabaseException {
  }

	
  protected void hook712(  BIN bin) throws DatabaseException {
    bin.releaseLatch();
    hook712__wrappee__base(bin);
  }

	
   private void  hook713__wrappee__base  (  INList inList,  IN subtreeRoot,  UtilizationTracker tracker) throws DatabaseException {
  ...
  protected void hook713(  INList inList,  IN subtreeRoot,  UtilizationTracker tracker) throws DatabaseException {
    inList.latchMajor();
    try {
      hook713__wrappee__base(inList,subtreeRoot,tracker);
    }
  finally {
   ...
   private void  hook714__wrappee__base  (  INList inMemoryList) throws DatabaseException {
  ...
  protected void hook714(  INList inMemoryList) throws DatabaseException {
    rootLatch.acquireShared();
    try {
      hook714__wrappee__base(inMemoryList);
    }
  finally {
      rootLatch.release();
    }
   ...
   private void  hook715__wrappee__base  (  int index) throws DatabaseException {
  ...
  protected void hook715(  int index) throws DatabaseException {
   ...
   private void  hook728__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook728() throws DatabaseException {
    rootLatch.acquireExclusive();
    hook728__wrappee__base();
  }

	
   private void  hook729__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook729() throws DatabaseException {
    rootLatch.acquireShared();
    hook729__wrappee__base();
  }

	
   private void  hook730__wrappee__base  (  IN in) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }

	
  protected void hook730(  IN in) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
    assert in.isLatchOwner();
    hook730__wrappee__base(in);
  }

	
   private void  hook731__wrappee__base  (  TreeLocation location) throws DatabaseException {
  }

	
  protected void hook731(  TreeLocation location) throws DatabaseException {
    location.bin.releaseLatch();
    hook731__wrappee__base(location);
  }

	
   private void  hook732__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook732() throws DatabaseException {
    assert (LatchSupport.countLatchesHeld() == 1) : LatchSupport.latchesHeldToString();
    hook732__wrappee__base();
  }

	
   private void  hook733__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook733() throws DatabaseException {
    assert (LatchSupport.countLatchesHeld() == 0) : LatchSupport.latchesHeldToString();
    hook733__wrappee__base();
  }

	
   private void  hook734__wrappee__base  (  IN next) throws DatabaseException {
  }

	
  protected void hook734(  IN next) throws DatabaseException {
    next.releaseLatch();
    hook734__wrappee__base(next);
  }

	
   private void  hook735__wrappee__base  (  IN nextIN) throws DatabaseException {
  }
  ...
  protected void hook735(  IN nextIN) throws DatabaseException {
    ...
    hook735__wrappee__base(nextIN);
  }

	
   private void  hook736__wrappee__base  (  IN parent) throws DatabaseException {
  }

	
  protected void hook736(  IN parent) throws DatabaseException {
    parent.releaseLatch();
    hook736__wrappee__base(parent);
  }

	
   private void  hook737__wrappee__base  (  IN parent) throws DatabaseException {
  }
  ...
  protected void hook737(  IN parent) throws DatabaseException {
    parent.releaseLatch();
    assert LatchSupport.countLatchesHeld() == 1 : LatchSupport.latchesHeldToString();
    hook737__wrappee__base(parent);
  }

	
   private void  hook738__wrappee__base  (  IN parent) throws DatabaseException, SplitRequiredException {
  }

	
  protected void hook738(  IN parent) throws DatabaseException, SplitRequiredException {
    parent.releaseLatch();
    hook738__wrappee__base(parent);
  }

	
   private void  hook739__wrappee__base  (  IN parent,  IN child) throws DatabaseException, SplitRequiredException {
  }
  ...
  protected void hook739(  IN parent,  IN child) throws DatabaseException, SplitRequiredException {
    child.releaseLatch();
    parent.releaseLatch();
    hook739__wrappee__base(parent,child);
  }

	
   private void  hook740__wrappee__base  (  IN child) throws DatabaseException, SplitRequiredException {
  }

	
  protected void hook740(  IN child) throws DatabaseException, SplitRequiredException {
    child.releaseLatch();
    hook740__wrappee__base(child);
  }

	
   private void  hook741__wrappee__base  (  BIN bin) throws DatabaseException {
  }

	
  protected void hook741(  BIN bin) throws DatabaseException {
    assert bin.isLatchOwner();
    hook741__wrappee__base(bin);
  }

	
   private void  hook742__wrappee__base  (  DBIN dupBin) throws DatabaseException {
  }

	
  protected void hook742(  DBIN dupBin) throws DatabaseException {
    dupBin.releaseLatch();
    hook742__wrappee__base(dupBin);
  }

	
   private void  hook743__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }

	
  protected void hook743(  CursorImpl cursor) throws DatabaseException {
    cursor.releaseBIN();
    hook743__wrappee__base(cursor);
  }

	
   private void  hook744__wrappee__base  (  DIN dupRoot) throws DatabaseException {
  }

	
  protected void hook744(  DIN dupRoot) throws DatabaseException {
    dupRoot.latch();
    hook744__wrappee__base(dupRoot);
  }

	
   private void  hook745__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }

	
  protected void hook745(  CursorImpl cursor) throws DatabaseException {
    cursor.releaseBIN();
    hook745__wrappee__base(cursor);
  }

	
   private void  hook746__wrappee__base  (  CursorImpl cursor) throws DatabaseException {
  }

	
  protected void hook746(  CursorImpl cursor) throws DatabaseException {
    cursor.latchBIN();
    hook746__wrappee__base(cursor);
  }

	
   private void  hook747__wrappee__base  (  DBIN dupBin) throws DatabaseException {
  }

	
  protected void hook747(  DBIN dupBin) throws DatabaseException {
    dupBin.releaseLatch();
    hook747__wrappee__base(dupBin);
  }

	
   private void  hook748__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook748() throws DatabaseException {
    rootLatch.acquireShared();
    hook748__wrappee__base();
  }

	
   private void  hook749__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook749() throws DatabaseException {
    rootLatch.release();
    hook749__wrappee__base();
  }

	
   private void  hook750__wrappee__base  (  BIN bin) throws DatabaseException {
  }

	
  protected void hook750(  BIN bin) throws DatabaseException {
    bin.latch();
    hook750__wrappee__base(bin);
  }

	
   private void  hook751__wrappee__base  () throws DatabaseException {
  }
  ...
  protected void hook751() throws DatabaseException {
    rootLatch.release();
    rootLatch.acquireExclusive();
    hook751__wrappee__base();
  }

	
   private void  hook752__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook752() throws DatabaseException {
    rootLatch.release();
    hook752__wrappee__base();
  }

	
   private void  hook753__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook753() throws DatabaseException {
    rootLatch.release();
    hook753__wrappee__base();
  }

	
   private void  hook754__wrappee__base  (  BIN bin) throws DatabaseException, NodeNotEmptyException, CursorsExistException {
  }
...
@MethodObject static  class  Tree_traceInsertDuplicate {
    ...
    Tree_traceInsertDuplicate(    Tree _this,    Level level,    EnvironmentImpl env,    BIN insertingDBin,    LN ln,    long lnLsn,    long binNid){
     ...
     private void  execute__wrappee__LoggingFiner  (){
    }
    ...
    void execute(){
      ...
      execute__wrappee__LoggingFiner();
    }
