 ...
 */
   private void  addCursor__wrappee__base  (  CursorImpl cursor){
 ...
 */
  public void addCursor(  CursorImpl cursor){
    assert isLatchOwner();
    addCursor__wrappee__base(cursor);
  }
 ...
 */
   private void  removeCursor__wrappee__base  (  CursorImpl cursor){
 ...
 */
  public void removeCursor(  CursorImpl cursor){
    assert isLatchOwner();
    removeCursor__wrappee__base(cursor);
  }
 ...
 */
   private void  adjustCursors__wrappee__base  (  IN newSibling,  int newSiblingLow,  int newSiblingHigh){
 ...
 */
  void adjustCursors(  IN newSibling,  int newSiblingLow,  int newSiblingHigh){
    ...
    adjustCursors__wrappee__base(newSibling,newSiblingLow,newSiblingHigh);
  }
 ...
 */
   private void  adjustCursorsForInsert__wrappee__base  (  int insertIndex){
    if (cursorSet != null) {
      Iterator iter=cursorSet.iterator();
      while (iter.hasNext()) {
        CursorImpl cursor=(CursorImpl)iter.next();
 ...
 */
  void adjustCursorsForInsert(  int insertIndex){
    assert this.isLatchOwner();
    adjustCursorsForInsert__wrappee__base(insertIndex);
  }
 ...
 * updated.
 */
   private void  adjustCursorsForMutation__wrappee__base  (  int binIndex,  DBIN dupBin,  int dupBinIndex,  CursorImpl excludeCursor){
    if (cursorSet != null) {
      Iterator iter=cursorSet.iterator();
      while (iter.hasNext()) {
        CursorImpl cursor=(CursorImpl)iter.next();
 ...
 */
  void adjustCursorsForMutation(  int binIndex,  DBIN dupBin,  int dupBinIndex,  CursorImpl excludeCursor){
    assert this.isLatchOwner();
    adjustCursorsForMutation__wrappee__base(binIndex,dupBin,dupBinIndex,excludeCursor);
  }
 ...
 */
  private boolean doDeltaLog(  BINDelta deltaInfo) throws DatabaseException {
   ...
   private void  hook603__wrappee__base  (  Node child) throws DatabaseException {
  }

	
  protected void hook603(  Node child) throws DatabaseException {
    ((IN)child).releaseLatch();
    hook603__wrappee__base(child);
  }

	
   private void  hook604__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook604() throws DatabaseException {
    releaseLatch();
    hook604__wrappee__base();
  }

	
   private void  hook605__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook605() throws DatabaseException {
    releaseLatch();
    hook605__wrappee__base();
  }

	
   private void  hook606__wrappee__base  () throws DatabaseException {
  }

	
  protected void hook606() throws DatabaseException {
    releaseLatch();
    hook606__wrappee__base();
  }

	
   private void  hook607__wrappee__base  (  int validIndex,  int numValidEntries,  boolean needToLatch) throws DatabaseException {
  ...
  protected void hook607(  int validIndex,  int numValidEntries,  boolean needToLatch) throws DatabaseException {
    ...
    try {
      hook607__wrappee__base(validIndex,numValidEntries,needToLatch);
    }
  finally {
   ...
   private void  hook608__wrappee__base  (  boolean needToLatch) throws DatabaseException {
  }
  ...
  protected void hook608(  boolean needToLatch) throws DatabaseException {
    ...
    hook608__wrappee__base(needToLatch);
  }

	
   private void  hook609__wrappee__base  (  BINReference binRef,  DatabaseImpl db) throws DatabaseException {
  }
  ...
  //  db.getDbEnvironment().addToCompressorQueue(binRef,false);
    hook609__wrappee__base(binRef,db);
  }

	
   private void  hook610__wrappee__base  (  int index){
  }

	
  protected void hook610(  int index){
    updateMemorySize(getTarget(index),null);
    hook610__wrappee__base(index);
  }
 ...
 */
   private long  evictLNs__wrappee__Evictor  () throws DatabaseException {
    Cleaner cleaner=getDatabase().getDbEnvironment().getCleaner();
    long removed=0;
    if (nCursors() == 0) {
      for (int i=0; i < getNEntries(); i++) {
 ...
 */
  public long evictLNs() throws DatabaseException {
    ...
    return evictLNs__wrappee__Evictor();
  }
 ...
 */
  private long evictInternal(  int index,  Cleaner cleaner) throws DatabaseException {
   ...
   private void  hook601__wrappee__Evictor  (  long removed) throws DatabaseException {
  }

	
  protected void hook601(  long removed) throws DatabaseException {
    updateMemorySize(removed,0);
    hook601__wrappee__Evictor(removed);
  }

	
   private void  hook602__wrappee__Evictor  (  long removed) throws DatabaseException {
  }

	
  protected void hook602(  long removed) throws DatabaseException {
    updateMemorySize(removed,0);
    hook602__wrappee__Evictor(removed);
  }
