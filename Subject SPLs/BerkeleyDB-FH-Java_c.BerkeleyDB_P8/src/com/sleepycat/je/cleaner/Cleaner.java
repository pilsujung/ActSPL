...
synchronized (deleteFileLock) {
  ...
  private void traceFileNotDeleted(  Exception e,  long fileNum){
    ...
    traceFileNotDeleted__wrappee__base(e,fileNum);
  }
...
@MethodObject static  class  Cleaner_processPending {
   ...
   private void  hook88__wrappee__base  (  long fileNumValue) throws DatabaseException {
  }
  ...
  protected void hook88(  long fileNumValue) throws DatabaseException {
    ...
    hook88__wrappee__base(fileNumValue);
  }

	
   private void  hook89__wrappee__base  (  DatabaseException DBE) throws DatabaseException {
  }
