...
@MethodObject static  class  Checkpointer_doCheckpoint {
    ...
    protected CheckpointEnd endEntry;
     ...
     private void  hook522__wrappee__base  () throws DatabaseException {
    }

		
    protected void hook522() throws DatabaseException {
      traced=false;
      hook522__wrappee__base();
    }

		
     private void  hook523__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook523() throws DatabaseException {
      ...
      traced=true;
      hook523__wrappee__base();
    }

		
     private void  hook524__wrappee__base  () throws DatabaseException {
    }
    ...
    protected void hook524() throws DatabaseException {
      ...
      hook524__wrappee__base();
    }

		
     private void  hook525__wrappee__base  () throws DatabaseException {
