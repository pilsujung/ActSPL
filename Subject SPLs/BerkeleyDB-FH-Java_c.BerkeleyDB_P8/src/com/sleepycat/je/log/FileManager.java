      ...
      execute__wrappee__base();
{
  ...
  protected void hook464(  Long fileId,  FileHandle fileHandle) throws LogException, DatabaseException {
   ...
   private void  hook465__wrappee__base  (  LogBuffer fullBuffer,  long firstLsn,  RandomAccessFile file) throws DatabaseException, ClosedChannelException, IOException {
  }
  ...
  protected void hook465(  LogBuffer fullBuffer,  long firstLsn,  RandomAccessFile file) throws DatabaseException, ClosedChannelException, IOException {
    ...
    hook465__wrappee__base(fullBuffer,firstLsn,file);
  }

	
   private void  hook466__wrappee__base  (  LogBuffer fullBuffer,  long firstLsn,  RandomAccessFile file,  ByteBuffer data,  IOException IOE) throws DatabaseException {
  ...
  protected void hook466(  LogBuffer fullBuffer,  long firstLsn,  RandomAccessFile file,  ByteBuffer data,  IOException IOE) throws DatabaseException {
    ...
    if (false)     hook466__wrappee__base(fullBuffer,firstLsn,file,data,IOE);
  }
