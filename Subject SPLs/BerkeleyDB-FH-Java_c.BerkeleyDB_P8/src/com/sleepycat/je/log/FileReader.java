...
@MethodObject static  class  FileReader_readNextEntry {
    ...
    protected LogEntryType problemType;
     ...
     private void  hook468__wrappee__base  () throws DatabaseException, IOException {
    }
   ...
   private void  hook469__wrappee__base  (  FileHandle fileHandle) throws IOException, DatabaseException, EOFException {
    readBuffer.clear();
  ...
  protected void hook469(  FileHandle fileHandle) throws IOException, DatabaseException, EOFException {
    try {
      hook469__wrappee__base(fileHandle);
    }
  finally {
      fileHandle.release();
    }
   ...
   private void  hook470__wrappee__base  (  FileHandle fileHandle) throws DatabaseException, EOFException, IOException {
  }

	
  protected void hook470(  FileHandle fileHandle) throws DatabaseException, EOFException, IOException {
    fileHandle.release();
    hook470__wrappee__base(fileHandle);
  }

	
   private void  hook471__wrappee__base  (  FileHandle fileHandle) throws DatabaseException, EOFException {
  }
  ...
  protected void hook471(  FileHandle fileHandle) throws DatabaseException, EOFException {
    ...
    hook471__wrappee__base(fileHandle);
  }
