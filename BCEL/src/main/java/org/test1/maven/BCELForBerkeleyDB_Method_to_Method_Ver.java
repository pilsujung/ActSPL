...
public class BCELForBerkeleyDB_Method_to_Method_Ver {
	static String target = "C:\\Users\\user\\Desktop\\eclipse-java-mars-2-win32-x86_64\\BerkeleyDB-FH-Java_c.BerkeleyDB_P1\\bin";
	...
	static public void main(String args[]) throws IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ClassNotFoundException {
		...
		System.out.println("checksum time: " + t +" ms");
	}
