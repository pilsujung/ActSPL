...
public class BCELForBerkeleyDB {
	static String target = "C:\\Users\\soo\\Desktop\\eclipse-java-mars-2-win32-x86_64\\BerkeleyDB-FH-Java_c.BerkeleyDB_P7\\bin";
	...
	//	        System.err.println("Could not get class ");
		    ...
		    for (int i = 0; i < methods.length; i++) {
		    	...
		    	else if(methods[i].getName().equals("clearEvoSuiteFramework")){
		    		MethodGen mgen = new MethodGen(methods[i], name + ".class", cp);
		    		InstructionList ilist = mgen.getInstructionList();
